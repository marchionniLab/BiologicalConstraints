...
l1 = load("../../Prostate/Objs/KTSP/bootobjectKTSP_AdhesionActivationO2response_RAND.rda")

list.boot[["KTSP"]] = 
  list(
    list(boot=bootobject_50, n=50),
...
l2 = load("../../Prostate/Objs/RF/RFBootObjects_AdhesionActivationO2response_RAND.rda")

list.boot[["RF"]] = 
  list(
    list(boot=bootobjectMech, n=0),
    list(boot=bootobjectAgnostic_50, n=50),
...
l3 = load("../../Prostate/Objs/SVM/SVMBootObjects_AdhesionActivationO2response_RAND.rda")
...
l4 = load("../../Prostate/Objs/XGB/XGBBootObjects_AdhesionActivationO2response_RAND.rda")
...
save(list.boot, df.list, file="rand_boot_prostate.rda")
