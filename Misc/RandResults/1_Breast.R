...
l1 = load("../../Breast/Objs/KTSP/bootobjectKTSP_NotchAndMYC_RAND.rda")
...
l2 = load("../../Breast/Objs/RF/RFBootObjects_NotchAndMyc_mech100pairs_RAND.rda")
...
l3 = load("../../Breast/Objs/SVM/SVMBootObjects_NotchAndMyc_mech100pairs_RAND.rda")
...
l4 = load("../../Breast/Objs/XGB/XGBBootObjects_NotchAndMyc_mech100pairs_RAND.rda")
...
save(list.boot, df.list, file="rand_boot_breast.rda")
