...
## plot
set.seed(333)
tiff(filename = 'figs/prostate_mech.tiff', width =  3000, height = 2000, res = 300)
...
plot(network_mech, 
     ...
     layout = l_mech, 
     edge.curved=0.1,
     main = 'Mechanistic gene pairs in predicting prostate cancer metastasis')
...
set.seed(333)
tiff(filename = 'figs/prostate_mech_cfg.tiff', width =  3000, height = 2000, res = 300)
plot(cfg_mech, network_mech, 
     ...
     layout = l_mech, 
     edge.curved=0.1,
     main = 'Mechanistic gene pairs in predicting prostate cancer metastasis (clusters)')
legend(x=-1.5, y=-1.0, c("gene1","gene2"), pch=21,
       col="#777777", pt.bg=c("tomato", "gold"), pt.cex=2, cex=.8, bty="n", ncol=1)
dev.off()
...
# vertices parameters
V(network_agnostic)$size <- V(network_agnostic)$gene_frequency*0.06
...
###
## plot
tiff(filename = 'figs/prostate_agnostic.tiff', width =  3000, height = 2000, res = 300)
...
plot(network_agnostic, 
     ...
     layout = l_agnostic,
     edge_curved =0.1,
     main = 'Agnostic gene pairs in predicting prostate cancer metastasis' 
)
legend(x=-1.5, y=-1.0, c("gene1","gene2"), pch=21,
       col="#777777", pt.bg=c("tomato", "gold"), pt.cex=2, cex=.8, bty="n", ncol=1)
dev.off()
...
set.seed(333)
tiff(filename = 'figs/prostate_agnostic_cfg.tiff', width =  3000, height = 2000, res = 200)
