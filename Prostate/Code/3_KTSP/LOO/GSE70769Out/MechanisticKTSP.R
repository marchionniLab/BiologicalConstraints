...
### TF_targets genes
## Leaving 1 dataset out (GSE70769)
#################################################################################
...
#################################################################
### Plot Curve
png("./Figs/KTSP/LOO/CompareAUCggplot_GSE70769Out.png",
...
### Plot
basicplot_KTSP_GSE70769Out <- ggplot(dat_KTSP, aes(d=Status, m=KTSP_sum, color=KTSP_type,
                                              linetype = KTSP_type)) +
...
### Plot
basicplot_KTSP_GSE70769Out
### Close device
dev.off()

save(basicplot_KTSP_GSE70769Out, file = "./Objs/KTSP/LOO/BasicPlot_KTSP_GSE70769Out.rda")
