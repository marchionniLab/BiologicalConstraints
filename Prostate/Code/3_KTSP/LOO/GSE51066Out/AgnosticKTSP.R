...
# plot the curve
ROCTest <- roc(usedTestGroup, ktspStatsTestUnRes$statistics, plot = F, print.auc=TRUE, ci = T, print.auc.col="black", levels = c("No_Mets", "Mets"), direction = "<", col= "blue", lwd=2, grid = TRUE, main = "Agnostic KTSP ROC Test")
ROCTest 
...
GSE51066_Out_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE51066_Out_AgnosticPerformance, file = "./Objs/KTSP/GSE51066_Out_AgnosticPerformance.rda")
