...
# plot the curve
ROCTest_500Feat <- roc(usedTestGroup, ktspStatsTestUnRes_500Feat$statistics, plot = F, print.auc=TRUE, ci = T, print.auc.col="black", levels = c("No_Mets", "Mets"), direction = "<", col= "blue", lwd=2, grid = TRUE, main = "Agnostic KTSP ROC Test")
ROCTest_500Feat 
...
GSE51066_Out_AgnosticPerformance_500Feat <- cbind(TrainPerf_500Feat, TestPerf_500Feat)

# Save
save(GSE51066_Out_AgnosticPerformance_500Feat, file = "./Objs/KTSP/GSE51066_Out_AgnosticPerformance_500Feat.rda")
