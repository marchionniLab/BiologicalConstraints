...
GSE55935_Out_AgnosticPerformance_500Feat <- cbind(TrainPerf_500Feat, TestPerf_500Feat)

# Save
save(GSE55935_Out_AgnosticPerformance_500Feat, file = "./Objs/KTSP/GSE55935_Out_AgnosticPerformance_500Feat.rda")
