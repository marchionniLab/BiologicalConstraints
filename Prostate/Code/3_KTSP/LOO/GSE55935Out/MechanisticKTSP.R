...
### TF_targets genes
## Leaving 1 dataset out (GSE55935)
#################################################################################
...
GSE55935_Out_MechPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE55935_Out_MechPerformance, file = "./Objs/KTSP/GSE55935_Out_MechPerformance.rda")
...
#################################################################
### Plot Curve
png("./Figs/KTSP/LOO/CompareAUCggplot_GSE55935Out.png",
...
### Plot
basicplot_KTSP_GSE55935Out <- ggplot(dat_KTSP, aes(d=Status, m=KTSP_sum, color=KTSP_type,
                                                    linetype = KTSP_type)) +
...
### Plot
basicplot_KTSP_GSE55935Out
### Close device
dev.off()

save(basicplot_KTSP_GSE55935Out, file = "./Objs/KTSP/LOO/BasicPlot_KTSP_GSE55935Out.rda")
