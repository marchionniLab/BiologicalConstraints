...
### TF_targets genes
## Leaving 1 dataset out (GSE46691)
#################################################################################
...
GSE46691_Out_MechPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE46691_Out_MechPerformance, file = "./Objs/KTSP/GSE46691_Out_MechPerformance.rda")
...
#################################################################
### Plot Curve
png("./Figs/KTSP/LOO/CompareAUCggplot_GSE46691Out.png",
...
### Plot
basicplot_KTSP_GSE46691Out <- ggplot(dat_KTSP, aes(d=Status, m=KTSP_sum, color=KTSP_type,
                                                   linetype = KTSP_type)) +
...
### Plot
basicplot_KTSP_GSE46691Out
### Close device
dev.off()

save(basicplot_KTSP_GSE46691Out, file = "./Objs/KTSP/LOO/BasicPlot_KTSP_GSE46691Out.rda")
