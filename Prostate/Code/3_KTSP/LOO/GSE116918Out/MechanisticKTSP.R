...
### TF_targets genes
## Leaving 1 dataset out (GSE116918)
#################################################################################
...
GSE116918_Out_MechPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE116918_Out_MechPerformance, file = "./Objs/KTSP/GSE116918_Out_MechPerformance.rda")
...
#################################################################
### Plot Curve
png("./Figs/KTSP/LOO/CompareAUCggplot_GSE116918Out.png",
...
### Plot
basicplot_KTSP_GSE116918Out <- ggplot(dat_KTSP, aes(d=Status, m=KTSP_sum, color=KTSP_type,
                                           linetype = KTSP_type)) +
...
### Plot
basicplot_KTSP_GSE116918Out
### Close device
dev.off()

save(basicplot_KTSP_GSE116918Out, file = "./Objs/KTSP/LOO/BasicPlot_KTSP_GSE116918Out.rda")
