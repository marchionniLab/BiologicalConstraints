...
# plot the curve
ROCTest <- roc(usedTestGroup, ktspStatsTestUnRes$statistics, plot = F, print.auc=TRUE, print.auc.col="black", levels = c("No_Mets", "Mets"), direction = "<", ci = T, col= "blue", lwd=2, grid = TRUE, main = "Agnostic KTSP ROC Test")
ROCTest 
...
GSE116918_Out_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE116918_Out_AgnosticPerformance, file = "./Objs/KTSP/GSE116918_Out_AgnosticPerformance.rda")
