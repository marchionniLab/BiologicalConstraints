...
############################################################
## Save all
save(bootobject_50, bootobject_100, bootobject_200, bootobject_500, file = "./Objs/KTSP/bootobjectKTSP.rda")
...
png("./Figs/KTSP/KTSP_BS_AUC_50.png", width = 3000, height = 1500, res = 300)
...
# All in one figure
png("./Figs/KTSP/KTSP_BS_AUC_DiffFeatures.png", width = 3000, height = 1500, res = 300)
