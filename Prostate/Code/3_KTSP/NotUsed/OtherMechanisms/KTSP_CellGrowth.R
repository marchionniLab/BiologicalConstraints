...
Genes <- load("/Users/mohamedomar/Desktop/Genes/MECHANISM/CancerHallmarks/CellGrowth/objs/growthPairs.v6.1.rda")
...
### Plot
basicplot_KTSP_Growth
### Close device
dev.off()

save(basicplot_KTSP_Growth, file = "./Objs/KTSP/BasicPlot_KTSP_Growth.rda")
