...
#####################
## Scatter plots
png(filename = "./Figs/KTSP/MechanisticKTSP_Train_ScatterPlot_Adhesion.png", width=3000, height=1500, res=300)
### Prepare ggplot
...
#####################
## Scatter plots
png(filename = "./Figs/KTSP/MechanisticKTSP_Test_ScatterPlot_Adhesion.png", width=3000, height=1500, res=300)
### Prepare ggplot
...
### Plot
basicplot_KTSP_Adhesion
### Close device
dev.off()

save(basicplot_KTSP_Adhesion, file = "./Objs/KTSP/BasicPlot_KTSP_Adhesion.rda")
