...
library(qusage)
AndrogenGenes <- read.gmt("/Volumes/Macintosh/Research/Genes/FGS_MOUSE_ANDROGEN_RESPONSE.gmt")

myTSPs <- expand.grid(AndrogenGenes$CARVER_CASTRATION_UP, AndrogenGenes$CARVER_CASTRATION_DN)
myTSPs <- as.matrix(myTSPs)

#If you want to switch columns
#myTSPs[ , c(1,2)] <- myTSPs[ , c(2,1)]
