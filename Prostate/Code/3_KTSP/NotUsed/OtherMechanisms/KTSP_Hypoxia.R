...
Genes <- load("/Volumes/Macintosh/Research/Projects/MechanisticGenes/Objs/HypoxiaPairs.rda")
myTSPs <- Hypoxia
...
### Plot
basicplot_KTSP_Hypoxia
### Close device
dev.off()

save(basicplot_KTSP_Hypoxia, file = "./Objs/KTSP/BasicPlot_KTSP_Hypoxia.rda")
