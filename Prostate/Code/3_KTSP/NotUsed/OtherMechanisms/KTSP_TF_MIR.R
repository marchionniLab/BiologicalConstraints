...
TF_MiR <- load("/Users/mohamedomar/Desktop/Genes/allTSPs.rda")
...
### Plot
basicplot_KTSP_TF_MiRNA <- ggplot(dat_KTSP, aes(d=Status, m=KTSP_sum, color=KTSP_type,
                                       linetype = KTSP_type)) +
...
save(basicplot_KTSP_TF_MiRNA, file = "./Objs/KTSP/BasicPlot_KTSP_TF_MiRNA.rda")
