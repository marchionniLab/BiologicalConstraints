...
Genes <- load("/Users/mohamedomar/Desktop/Genes/MECHANISM/CancerHallmarks/Angiogenesis/objs/angiogenesisPairs.v6.1.rda")
myTSPs <- angiogenesisPairs
...
save(basicplot_KTSP_Angio, file = "./Objs/KTSP/BasicPlot_KTSP_Angio.rda")
