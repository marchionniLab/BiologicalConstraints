...
#####################
## Load the 4 graphs
load("./Objs/KTSP/BasicPlot_KTSP_Hallmarks.rda")
load("./Objs/SVM/BasicPlot_SVM_Hallmarks.rda")
load("./Objs/RF/BasicPlot_RF_Pairs_Hallmarks.rda")
load("./Objs/XGB/BasicPlot_XGB_Pairs_Hallmarks.rda")
...
## Plot the panel
png("./Figs/CompareAUC_Panel_Hallmarks.png", width = 6000, height = 4000, res = 360)
