...
## Load data
load("./Objs/KTSP/KTSP_STATs_Mechanistic_NotchAndMYC.rda")
...
save(ModelCompare_RF, file = "./Objs/RF/ModelCompare_RF_NotchAndMYC.rda")
...
png("./Figs/RF/RF_BS_AUC_50_NotchAndMYC.png", width = 3000, height = 1500, res = 300)
...
png("./Figs/RF/RF_BS_AUC_100_NotchAndMYC.png", width = 3000, height = 1500, res = 300)
...
png("./Figs/RF/RF_BS_AUC_200_NotchAndMYC.png", width = 3000, height = 1500, res = 300)
...
png("./Figs/RF/RF_BS_AUC_500_NotchAndMYC.png", width = 3000, height = 1500, res = 300)
...
# All in one figure
png("./Figs/RF/RF_BS_AUC_DiffFeatures_NotchAndMYC.png", width = 3000, height = 1500, res = 300)
