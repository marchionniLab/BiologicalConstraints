...
## Load data
load("./Objs/KTSP/KTSP_STATs_Mechanistic_StromaANDlipogenesis.rda")
...
save(bootobjectAgnostic, bootobjectMech, file = "./Objs/RF/RFBootObjects_StromaANDlipogenesis_AgnIndvGns.rda")

load("./Objs/RF/RFBootObjects_StromaANDlipogenesis_AgnIndvGns.rda")
...
png("./Figs/RF/RF_BS_StromaANDlipogenesis_AgnIndvGns.png", width = 3000, height = 1500, res = 300)
