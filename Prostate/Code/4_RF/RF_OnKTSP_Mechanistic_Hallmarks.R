...
set.seed(333)
RF_Mechanistic_OnKTSP <- randomForest(x =predictor_data, y=usedTrainGroup, importance = TRUE, ntree = 1001, mtry = 3, proximity=TRUE, na.action = na.omit, sampsize = sampsizes)
...
###################
### Plot Curve
png("./Figs/RF/CompareAUCggplot_Hallmarks.png",
...
save(basicplot_RF_Pairs, file = "./Objs/RF/BasicPlot_RF_Pairs_Hallmarks.rda")
