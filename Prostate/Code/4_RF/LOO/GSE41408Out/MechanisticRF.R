...
## Load data
load("./Objs/KTSP/LOO/KTSP_STATs_Mechanistic_GSE41408Out.rda")
...
GSE41408_Out_RF_MechPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE41408_Out_RF_MechPerformance, file = "./Objs/RF/GSE41408_Out_RF_MechPerformance.rda")
