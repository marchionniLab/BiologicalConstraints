...
## Agnostic
load("./Objs/KTSP/LOO/KTSP_STATs_Agnostic_GSE46691Out.rda")
...
set.seed(333)
RF_Agnostic_OnKTSP <- randomForest(x =predictor_data, y=usedTrainGroup, importance = TRUE, ntree = 501, mtry = 40 ,proximity=TRUE, na.action = na.omit, sampsize = sampsizes)
RF_Agnostic_OnKTSP
