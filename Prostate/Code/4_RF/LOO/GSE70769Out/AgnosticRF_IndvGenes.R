...
set.seed(333)
RF_Agnostic <- randomForest(x =predictor_data, y=target, importance = TRUE, ntree = 1000, mtry = 252 ,proximity=TRUE, na.action = na.omit, sampsize = sampsizes)
print(RF_Agnostic)
...
GSE70769_Out_RF_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE70769_Out_RF_IndvGenes_AgnosticPerformance, file = "./Objs/RF/GSE70769_Out_RF_IndvGenes_AgnosticPerformance.rda")
