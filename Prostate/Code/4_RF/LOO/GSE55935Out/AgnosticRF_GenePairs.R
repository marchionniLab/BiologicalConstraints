...
GSE55935_Out_RF_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE55935_Out_RF_AgnosticPerformance, file = "./Objs/RF/GSE55935_Out_RF_AgnosticPerformance.rda")
