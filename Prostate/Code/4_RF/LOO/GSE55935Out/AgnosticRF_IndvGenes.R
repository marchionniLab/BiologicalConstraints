...
set.seed(333)
RF_Agnostic <- randomForest(x =predictor_data, y=target, importance = TRUE, ntree = 1000, mtry = 63 ,proximity=TRUE, na.action = na.omit, sampsize = sampsizes)
print(RF_Agnostic)
...
GSE55935_Out_RF_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE55935_Out_RF_IndvGenes_AgnosticPerformance, file = "./Objs/RF/GSE55935_Out_RF_IndvGenes_AgnosticPerformance.rda")
