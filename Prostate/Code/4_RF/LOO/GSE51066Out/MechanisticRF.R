...
## Load data
load("./Objs/KTSP/LOO/KTSP_STATs_Mechanistic_GSE51066Out.rda")
...
set.seed(333)
RF_Mechanistic_OnKTSP <- randomForest(x =predictor_data, y=usedTrainGroup, importance = TRUE, ntree = 500, mtry = 7, proximity=TRUE, na.action = na.omit, sampsize = sampsizes)
...
GSE51066_Out_RF_MechPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE51066_Out_RF_MechPerformance, file = "./Objs/RF/GSE51066_Out_RF_MechPerformance.rda")
