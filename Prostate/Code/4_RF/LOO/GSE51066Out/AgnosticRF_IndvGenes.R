...
GSE51066_Out_RF_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE51066_Out_RF_IndvGenes_AgnosticPerformance, file = "./Objs/RF/GSE51066_Out_RF_IndvGenes_AgnosticPerformance.rda")
