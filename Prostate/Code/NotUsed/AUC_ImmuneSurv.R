...
### Using : Immune Surveillance genes
...
############################################################################
### Plot
png("./Figs/ImmuneSurv/mechanistic.AUCbyKTSP.png", width = 3000, height = 1500, res = 200)
...
###############################################################################
### Plot
png("./Figs/ImmuneSurv/mechanistic.AUCbyKTSP.fixed.png", width = 3000, height = 1500, res = 200)
## Prepare pallette and layout
myCol <- c(brewer.pal(3, "Dark2")[c(3)], rgb(0.11, 0.62, 0.47, 0.65), rgb(0.85, 0.37, 0.1, 0.65))
par(margin= c(5,5,3,5), mgp=c(3,0.75,0))
## Prepare coordinates
