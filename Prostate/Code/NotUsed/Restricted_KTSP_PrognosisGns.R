...
ktspPredictorRes <- SWAP.Train.KTSP(
  usedTrainMat, usedTrainGroup, krange=5,
...
## Plot curve
roc(usedTestGroup, ktspStatsTestRes$statistics, plot = F, print.thres=thr_test, print.auc=TRUE, print.auc.col="black", levels = c("No_Mets", "Mets"), direction = ">", col="blue", lwd=2, grid=TRUE, auc = TRUE, ci = TRUE, percent = TRUE, main= "Mechanistic KTSP using Combined Gns")
...
########################
## Make paired boxplot
png("./Figs/Prognosis_genes/mechanistic.trainKTSPexprs.png", width = 3000, height = 1500, res = 200)
...
########################
## Make paired boxplot
png("./Figs/Prognosis_genes/mechanistic.testKTSPexprs.png", width = 3000, height = 1500, res = 200)
...
#######################################################################
#### SAVE
save(list = ls(pattern = "^ktsp"), file = "./Objs/Prognosis_genes/mechanistic.ktspPredictor.rda")
