...
Prostate_metaanalysis$filterResults$FDR0.1_es0_nStudies6_looaFALSE_hetero0$posGeneNames <- c("BGN", "COL1A1", "SFRP4", "TPX2")
Prostate_metaanalysis$filterResults$FDR0.1_es0_nStudies6_looaFALSE_hetero0$negGeneNames <- c("FLNC", "GSN", "TPM2", "GSTM2", "LAMB3", "FAM13C", "KLK2", "AZGP1", "SRD5A2", "DUSP1", "FOS")
...
set.seed(333)
pooledROCPlot(metaObject = Prostate_metaanalysis, filterObject = OncoDx_Filter)
###########################################################################################
#############################################################################
...
rocPlot(datasetObject = valDataSet3, filterObject = OncoDx_Filter)

# Validation dataset4
valDataSet4$keys <- rownames(val_expr4)
rocPlot(datasetObject = valDataSet4, filterObject = OncoDx_Filter)
...
# val dataset3
prcPlot(datasetObject = valDataSet3, filterObject =OncoDx_Filter)

# val dataset4
prcPlot(datasetObject = valDataSet4, filterObject =OncoDx_Filter)
...
violinPlot(filterObject = OncoDx_Filter, datasetObject = valDataSet3, labelColumn = "Metastasis")

violinPlot(filterObject = OncoDx_Filter, datasetObject = valDataSet4, labelColumn = "Metastasis")
...
# Val Dataset3
val_pheno3$score <- calculateScore(filterObject = OncoDx_Filter, datasetObject = valDataSet3)

# Val Dataset4
val_pheno4$score <- calculateScore(filterObject = OncoDx_Filter, datasetObject = valDataSet4)
...
set.seed(333)
summaryROCPlot(metaObject = Meta_Test, filterObject = OncoDx_Filter)

set.seed(333)
png(filename = "./Objs/Meta/OncoDx_pooledROC_Testing.png", width = 2000, height = 2000, res = 300)
pooledROCPlot(metaObject = Meta_Test, filterObject = OncoDx_Filter)
dev.off()
