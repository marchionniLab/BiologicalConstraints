...
train_pred_classes_svmPoly_agnostic_OnKTSP <- predict(fit.svmPoly_agnostic_OnKTSP, Training, type="raw")
...
test_pred_classes_svmPoly_agnostic_OnKTSP <- predict(fit.svmPoly_agnostic_OnKTSP, Testing, type="raw")
...
roc(usedTestGroup, test_pred_prob_svmPoly_agnostic_OnKTSP[,2], plot = F, print.auc=TRUE, levels = c("No_Mets", "Mets"), direction = "<", col="blue", ci = T,lwd=2, grid=TRUE, main = "ROC Test SVM Poly (Agnostic)")
...
roc(usedTrainGroup, train_pred_prob_svmPoly_agnostic_OnKTSP[,2], plot = TRUE, print.auc=TRUE, levels = c("No_Mets", "Mets"), direction = "<", col="blue", lwd=2, grid=TRUE, main = "ROC train SVM Poly (Agnostic)")
