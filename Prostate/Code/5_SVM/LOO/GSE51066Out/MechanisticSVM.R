...
Grid <- expand.grid(degree = 3, scale = 0.01, C = 0.5)
set.seed(333)
...
GSE51066_Out_SVM_MechPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE51066_Out_SVM_MechPerformance, file = "./Objs/SVM/GSE51066_Out_SVM_MechPerformance.rda")
