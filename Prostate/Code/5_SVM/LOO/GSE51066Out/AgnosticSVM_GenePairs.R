...
GSE51066_Out_SVM_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE51066_Out_SVM_AgnosticPerformance, file = "./Objs/SVM/GSE51066_Out_SVM_AgnosticPerformance.rda")
