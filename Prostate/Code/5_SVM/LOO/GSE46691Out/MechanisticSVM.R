...
ROCTrain <- roc(usedTrainGroup, train_pred_prob_svmPoly_mechanistic_OnKTSP[,2], plot = F, print.auc=TRUE, ci = T, levels = c("No_Mets", "Mets"), direction = "<", col="blue", lwd=2, grid=TRUE, main = "ROC Test SVM Poly (Mechanistic)")
ROCTrain
...
ROCTest <- roc(usedTestGroup, test_pred_prob_svmPoly_mechanistic_OnKTSP[,2], plot = F, print.auc=TRUE, ci = T, levels = c("No_Mets", "Mets"), direction = "<", col="blue", lwd=2, grid=TRUE, main = "ROC Test SVM Poly (Mechanistic)")
ROCTest
...
GSE46691_Out_SVM_MechPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE46691_Out_SVM_MechPerformance, file = "./Objs/SVM/GSE46691_Out_SVM_MechPerformance.rda")
