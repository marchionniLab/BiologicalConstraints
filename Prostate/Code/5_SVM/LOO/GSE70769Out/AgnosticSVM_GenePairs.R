...
GSE70769_Out_SVM_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE70769_Out_SVM_AgnosticPerformance, file = "./Objs/SVM/GSE70769_Out_SVM_AgnosticPerformance.rda")
