...
JHU_Out_SVM_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(JHU_Out_SVM_IndvGenes_AgnosticPerformance, file = "./Objs/SVM/JHU_Out_SVM_IndvGenes_AgnosticPerformance.rda")
