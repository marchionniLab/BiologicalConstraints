...
AgnosticGSE116918_Out_pairs <- load("./Objs/SVM/GSE116918_Out_SVM_AgnosticPerformance.rda")
AgnosticGSE55935_Out_pairs <- load("./Objs/SVM/GSE55935_Out_SVM_AgnosticPerformance.rda")
AgnosticGSE51066_Out_pairs <- load("./Objs/SVM/GSE51066_Out_SVM_AgnosticPerformance.rda")
AgnosticGSE46691_Out_pairs <- load("./Objs/SVM/GSE46691_Out_SVM_AgnosticPerformance.rda")
AgnosticGSE41408_Out_pairs <- load("./Objs/SVM/GSE41408_Out_SVM_AgnosticPerformance.rda")
AgnosticJHU_Out_pairs <- load("./Objs/SVM/JHU_Out_SVM_AgnosticPerformance.rda")
AgnosticGSE70769_Out_pairs <- load("./Objs/SVM/GSE70769_Out_SVM_AgnosticPerformance.rda")

# Load the agnostic genes models
AgnosticGSE116918_Out_indvGenes <- load("./Objs/SVM/GSE116918_Out_SVM_IndvGenes_AgnosticPerformance.rda")
AgnosticGSE55935_Out_indvGenes <- load("./Objs/SVM/GSE55935_Out_SVM_IndvGenes_AgnosticPerformance.rda")
AgnosticGSE51066_Out_indvGenes <- load("./Objs/SVM/GSE51066_Out_SVM_IndvGenes_AgnosticPerformance.rda")
AgnosticGSE46691_Out_indvGenes <- load("./Objs/SVM/GSE46691_Out_SVM_IndvGenes_AgnosticPerformance.rda")
AgnosticGSE41408_Out_indvGenes <- load("./Objs/SVM/GSE41408_Out_SVM_IndvGenes_AgnosticPerformance.rda")
AgnosticJHU_Out_indvGenes <- load("./Objs/SVM/JHU_Out_SVM_IndvGenes_AgnosticPerformance.rda")
AgnosticGSE70769_Out_indvGenes <- load("./Objs/SVM/GSE70769_Out_SVM_IndvGenes_AgnosticPerformance.rda")

# Load the Mech models
MechGSE116918_Out <- load("./Objs/SVM/GSE116918_Out_SVM_MechPerformance.rda")
MechGSE55935_Out <- load("./Objs/SVM/GSE55935_Out_SVM_MechPerformance.rda")
MechGSEGSE51066_Out <- load("./Objs/SVM/GSE51066_Out_SVM_MechPerformance.rda")
MechGSE46691_Out <- load("./Objs/SVM/GSE46691_Out_SVM_MechPerformance.rda")
MechGSE41408_Out <- load("./Objs/SVM/GSE41408_Out_SVM_MechPerformance.rda")
MechJHU_Out <- load("./Objs/SVM/JHU_Out_SVM_MechPerformance.rda")
MechGSE70769_Out <- load("./Objs/SVM/GSE70769_Out_SVM_MechPerformance.rda")
...
# GSE116918_out
GSE116918_Out_SVM_AgnosticPerformance$out_study <- rep("GSE116918", nrow(GSE116918_Out_SVM_AgnosticPerformance))
GSE116918_Out_SVM_IndvGenes_AgnosticPerformance$out_study <- rep("GSE116918", nrow(GSE116918_Out_SVM_IndvGenes_AgnosticPerformance))
GSE116918_Out_SVM_MechPerformance$out_study <- rep("GSE116918", nrow(GSE116918_Out_SVM_MechPerformance))

GSE116918_Out_SVM_AgnosticPerformance$model_type <- rep("Agnostic_pairs", nrow(GSE116918_Out_SVM_AgnosticPerformance))
GSE116918_Out_SVM_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_genes", nrow(GSE116918_Out_SVM_IndvGenes_AgnosticPerformance))
GSE116918_Out_SVM_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE116918_Out_SVM_MechPerformance))

######
# GSE55935_out
GSE55935_Out_SVM_AgnosticPerformance$out_study <- rep("GSE55935", nrow(GSE55935_Out_SVM_AgnosticPerformance))
GSE55935_Out_SVM_IndvGenes_AgnosticPerformance$out_study <- rep("GSE55935", nrow(GSE55935_Out_SVM_IndvGenes_AgnosticPerformance))
GSE55935_Out_SVM_MechPerformance$out_study <- rep("GSE55935", nrow(GSE55935_Out_SVM_MechPerformance))

GSE55935_Out_SVM_AgnosticPerformance$model_type <- rep("Agnostic_pairs", nrow(GSE55935_Out_SVM_AgnosticPerformance))
GSE55935_Out_SVM_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_genes", nrow(GSE55935_Out_SVM_IndvGenes_AgnosticPerformance))
GSE55935_Out_SVM_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE55935_Out_SVM_MechPerformance))

#######
# GSE51066_out
GSE51066_Out_SVM_AgnosticPerformance$out_study <- rep("GSE51066", nrow(GSE51066_Out_SVM_AgnosticPerformance))
GSE51066_Out_SVM_IndvGenes_AgnosticPerformance$out_study <- rep("GSE51066", nrow(GSE51066_Out_SVM_IndvGenes_AgnosticPerformance))
GSE51066_Out_SVM_MechPerformance$out_study <- rep("GSE51066", nrow(GSE51066_Out_SVM_MechPerformance))

GSE51066_Out_SVM_AgnosticPerformance$model_type <- rep("Agnostic_pairs", nrow(GSE51066_Out_SVM_AgnosticPerformance))
GSE51066_Out_SVM_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_genes", nrow(GSE51066_Out_SVM_IndvGenes_AgnosticPerformance))
GSE51066_Out_SVM_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE51066_Out_SVM_MechPerformance))

#######
# GSE46691_out
GSE46691_Out_SVM_AgnosticPerformance$out_study <- rep("GSE46691", nrow(GSE46691_Out_SVM_AgnosticPerformance))
GSE46691_Out_SVM_IndvGenes_AgnosticPerformance$out_study <- rep("GSE46691", nrow(GSE46691_Out_SVM_IndvGenes_AgnosticPerformance))
GSE46691_Out_SVM_MechPerformance$out_study <- rep("GSE46691", nrow(GSE46691_Out_SVM_MechPerformance))

GSE46691_Out_SVM_AgnosticPerformance$model_type <- rep("Agnostic_pairs", nrow(GSE46691_Out_SVM_AgnosticPerformance))
GSE46691_Out_SVM_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_genes", nrow(GSE46691_Out_SVM_IndvGenes_AgnosticPerformance))
GSE46691_Out_SVM_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE46691_Out_SVM_MechPerformance))

#######
# GSE41408_out
GSE41408_Out_SVM_AgnosticPerformance$out_study <- rep("GSE41408", nrow(GSE41408_Out_SVM_AgnosticPerformance))
GSE41408_Out_SVM_IndvGenes_AgnosticPerformance$out_study <- rep("GSE41408", nrow(GSE41408_Out_SVM_IndvGenes_AgnosticPerformance))
GSE41408_Out_SVM_MechPerformance$out_study <- rep("GSE41408", nrow(GSE41408_Out_SVM_MechPerformance))

GSE41408_Out_SVM_AgnosticPerformance$model_type <- rep("Agnostic_pairs", nrow(GSE41408_Out_SVM_AgnosticPerformance))
GSE41408_Out_SVM_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_genes", nrow(GSE41408_Out_SVM_IndvGenes_AgnosticPerformance))
GSE41408_Out_SVM_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE41408_Out_SVM_MechPerformance))

#######
# JHU_out
JHU_Out_SVM_AgnosticPerformance$out_study <- rep("JHU", nrow(JHU_Out_SVM_AgnosticPerformance))
JHU_Out_SVM_IndvGenes_AgnosticPerformance$out_study <- rep("JHU", nrow(JHU_Out_SVM_IndvGenes_AgnosticPerformance))
JHU_Out_SVM_MechPerformance$out_study <- rep("JHU", nrow(JHU_Out_SVM_MechPerformance))

JHU_Out_SVM_AgnosticPerformance$model_type <- rep("Agnostic_pairs", nrow(JHU_Out_SVM_AgnosticPerformance))
JHU_Out_SVM_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_genes", nrow(JHU_Out_SVM_IndvGenes_AgnosticPerformance))
JHU_Out_SVM_MechPerformance$model_type <- rep("Mechanistic", nrow(JHU_Out_SVM_MechPerformance))

#######
# GSE70769_out
GSE70769_Out_SVM_AgnosticPerformance$out_study <- rep("GSE70769", nrow(GSE70769_Out_SVM_AgnosticPerformance))
GSE70769_Out_SVM_IndvGenes_AgnosticPerformance$out_study <- rep("GSE70769", nrow(GSE70769_Out_SVM_IndvGenes_AgnosticPerformance))
GSE70769_Out_SVM_MechPerformance$out_study <- rep("GSE70769", nrow(GSE70769_Out_SVM_MechPerformance))

GSE70769_Out_SVM_AgnosticPerformance$model_type <- rep("Agnostic_pairs", nrow(GSE70769_Out_SVM_AgnosticPerformance))
GSE70769_Out_SVM_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_genes", nrow(GSE70769_Out_SVM_IndvGenes_AgnosticPerformance))
GSE70769_Out_SVM_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE70769_Out_SVM_MechPerformance))



All_SVM_CV <- rbind(GSE116918_Out_SVM_AgnosticPerformance, GSE116918_Out_SVM_IndvGenes_AgnosticPerformance, GSE116918_Out_SVM_MechPerformance,
                   GSE55935_Out_SVM_AgnosticPerformance, GSE55935_Out_SVM_IndvGenes_AgnosticPerformance, GSE55935_Out_SVM_MechPerformance,
                   GSE51066_Out_SVM_AgnosticPerformance, GSE51066_Out_SVM_IndvGenes_AgnosticPerformance, GSE51066_Out_SVM_MechPerformance, 
                   GSE46691_Out_SVM_AgnosticPerformance, GSE46691_Out_SVM_IndvGenes_AgnosticPerformance, GSE46691_Out_SVM_MechPerformance, 
                   GSE41408_Out_SVM_AgnosticPerformance, GSE41408_Out_SVM_IndvGenes_AgnosticPerformance, GSE41408_Out_SVM_MechPerformance,
                   JHU_Out_SVM_AgnosticPerformance, JHU_Out_SVM_IndvGenes_AgnosticPerformance, JHU_Out_SVM_MechPerformance,
                   GSE70769_Out_SVM_AgnosticPerformance, GSE70769_Out_SVM_IndvGenes_AgnosticPerformance, GSE70769_Out_SVM_MechPerformance)
...
## AUC
# Mean AUC in both the training and testing data
MeanAUC_Agnostic_genes <-  apply(All_SVM_CV %>%
...
# AUC SD in both the training and testing data
SD_AUC_Agnostic_genes <-  apply(All_SVM_CV %>%
                                  filter(model_type == "Agnostic_genes") %>%
                                  filter(metric == "AUC") %>%
                                  select(c("Training", "Testing")), 2, sd)
...
### Accuracy
# Mean Accuracy in both the training and testing data
MeanAccuracy_Agnostic_genes <-  apply(All_SVM_CV %>%
                                        filter(model_type == "Agnostic_genes") %>%
                                        filter(metric == "Accuracy") %>%
                                        select(c("Training", "Testing")), 2, mean)

# Accuracy SD in both the training and testing data
SD_Accuracy_Agnostic_genes <-  apply(All_SVM_CV %>%
                                       filter(model_type == "Agnostic_genes") %>%
                                       filter(metric == "Accuracy") %>%
                                       select(c("Training", "Testing")), 2, sd)
...
### Balanced Accuracy
# Mean Balanced Accuracy in both the training and testing data
MeanBalAccuracy_Agnostic_genes <-  apply(All_SVM_CV %>%
                                           filter(model_type == "Agnostic_genes") %>%
                                           filter(metric == "Bal.Accuracy") %>%
                                           select(c("Training", "Testing")), 2, mean)

# Balanced Accuracy SD in both the training and testing data
SD_BalAccuracy_Agnostic_genes <-  apply(All_SVM_CV %>%
                                          filter(model_type == "Agnostic_genes") %>%
                                          filter(metric == "Bal.Accuracy") %>%
                                          select(c("Training", "Testing")), 2, sd)
...
### Sensitivity
# Mean Sensitivity in both the training and testing data
MeanSensitivity_Agnostic_genes <-  apply(All_SVM_CV %>%
                                           filter(model_type == "Agnostic_genes") %>%
                                           filter(metric == "Sensitivity") %>%
                                           select(c("Training", "Testing")), 2, mean)

# Sensitivity SD in both the training and testing data
SD_Sensitivity_Agnostic_genes <-  apply(All_SVM_CV %>%
                                          filter(model_type == "Agnostic_genes") %>%
                                          filter(metric == "Sensitivity") %>%
                                          select(c("Training", "Testing")), 2, sd)
...
### Specificity
# Mean Specificity in both the training and testing data
MeanSpecificity_Agnostic_genes <-  apply(All_SVM_CV %>%
                                           filter(model_type == "Agnostic_genes") %>%
                                           filter(metric == "Specificity") %>%
                                           select(c("Training", "Testing")), 2, mean)

# Specificity SD in both the training and testing data
SD_Specificity_Agnostic_genes <-  apply(All_SVM_CV %>%
                                          filter(model_type == "Agnostic_genes") %>%
                                          filter(metric == "Specificity") %>%
                                          select(c("Training", "Testing")), 2, sd)
...
### MCC
# Mean MCC in both the training and testing data
MeanMCC_Agnostic_genes <-  apply(All_SVM_CV %>%
                                   filter(model_type == "Agnostic_genes") %>%
                                   filter(metric == "MCC") %>%
                                   select(c("Training", "Testing")), 2, mean)

# MCC SD in both the training and testing data
SD_MCC_Agnostic_genes <-  apply(All_SVM_CV %>%
                                  filter(model_type == "Agnostic_genes") %>%
                                  filter(metric == "MCC") %>%
                                  select(c("Training", "Testing")), 2, sd)
