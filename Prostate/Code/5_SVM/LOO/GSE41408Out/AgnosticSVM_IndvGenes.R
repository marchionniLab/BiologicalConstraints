...
GSE41408_Out_SVM_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE41408_Out_SVM_IndvGenes_AgnosticPerformance, file = "./Objs/SVM/GSE41408_Out_SVM_IndvGenes_AgnosticPerformance.rda")
