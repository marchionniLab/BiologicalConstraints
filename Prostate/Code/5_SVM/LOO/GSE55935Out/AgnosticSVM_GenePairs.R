...
GSE55935_Out_SVM_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE55935_Out_SVM_AgnosticPerformance, file = "./Objs/SVM/GSE55935_Out_SVM_AgnosticPerformance.rda")
