...
load("./Objs/SVM/SVM_MechBootObject_AdhesionActivationO2response.rda")
...
Grid_agn25pairs <- expand.grid(degree = 3, scale = 0.001, C = 0.25)
...
Grid_agn50pairs <- expand.grid(degree = 3, scale = 0.01, C = 0.25)
...
Grid_agn250pairs <- expand.grid(degree = 3, scale = 0.01, C = 0.25)
...
########################################################################################
## Save all Objects
save(bootobjectMech, bootobjectAgnostic_25, bootobjectAgnostic_50, bootobjectAgnostic_100, bootobjectAgnostic_250, file= "./Objs/SVM/SVMBootObjects_AdhesionActivationO2response_AgnPairs_new.rda")

## Load
load("./Objs/SVM/SVMBootObjects_AdhesionActivationO2response_AgnPairs.rda")
