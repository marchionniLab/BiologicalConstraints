...
## Agnostic
load("./Objs/KTSP/LOO/KTSP_STATs_Agnostic_GSE55935Out.rda")
...
GSE55935_Out_XGB_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE55935_Out_XGB_AgnosticPerformance, file = "./Objs/XGB/GSE55935_Out_XGB_AgnosticPerformance.rda")
