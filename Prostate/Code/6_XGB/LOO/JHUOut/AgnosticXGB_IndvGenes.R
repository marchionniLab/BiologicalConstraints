...
JHU_Out_XGB_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(JHU_Out_XGB_IndvGenes_AgnosticPerformance, file = "./Objs/XGB/JHU_Out_XGB_IndvGenes_AgnosticPerformance.rda")
