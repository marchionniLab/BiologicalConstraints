...
GSE51066_Out_XGB_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE51066_Out_XGB_AgnosticPerformance, file = "./Objs/XGB/GSE51066_Out_XGB_AgnosticPerformance.rda")
