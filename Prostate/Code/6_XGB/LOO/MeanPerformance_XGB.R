...
AgnosticGSE116918_Out_pairs <- load("./Objs/XGB/GSE116918_Out_XGB_AgnosticPerformance.rda")
AgnosticGSE55935_Out_pairs <- load("./Objs/XGB/GSE55935_Out_XGB_AgnosticPerformance.rda")
AgnosticGSE51066_Out_pairs <- load("./Objs/XGB/GSE51066_Out_XGB_AgnosticPerformance.rda")
AgnosticGSE46691_Out_pairs <- load("./Objs/XGB/GSE46691_Out_XGB_AgnosticPerformance.rda")
AgnosticGSE41408_Out_pairs <- load("./Objs/XGB/GSE41408_Out_XGB_AgnosticPerformance.rda")
AgnosticJHU_Out_pairs <- load("./Objs/XGB/JHU_Out_XGB_AgnosticPerformance.rda")
AgnosticGSE70769_Out_pairs <- load("./Objs/XGB/GSE70769_Out_XGB_AgnosticPerformance.rda")

# Load the agnostic genes models
AgnosticGSE116918_Out_indvGenes <- load("./Objs/XGB/GSE116918_Out_XGB_IndvGenes_AgnosticPerformance.rda")
AgnosticGSE55935_Out_indvGenes <- load("./Objs/XGB/GSE55935_Out_XGB_IndvGenes_AgnosticPerformance.rda")
AgnosticGSE51066_Out_indvGenes <- load("./Objs/XGB/GSE51066_Out_XGB_IndvGenes_AgnosticPerformance.rda")
AgnosticGSE46691_Out_indvGenes <- load("./Objs/XGB/GSE46691_Out_XGB_IndvGenes_AgnosticPerformance.rda")
AgnosticGSE41408_Out_indvGenes <- load("./Objs/XGB/GSE41408_Out_XGB_IndvGenes_AgnosticPerformance.rda")
AgnosticJHU_Out_indvGenes <- load("./Objs/XGB/JHU_Out_XGB_IndvGenes_AgnosticPerformance.rda")
AgnosticGSE70769_Out_indvGenes <- load("./Objs/XGB/GSE70769_Out_XGB_IndvGenes_AgnosticPerformance.rda")

# Load the Mech models
MechGSE116918_Out <- load("./Objs/XGB/GSE116918_Out_XGB_MechPerformance.rda")
MechGSE55935_Out <- load("./Objs/XGB/GSE55935_Out_XGB_MechPerformance.rda")
MechGSEGSE51066_Out <- load("./Objs/XGB/GSE51066_Out_XGB_MechPerformance.rda")
MechGSE46691_Out <- load("./Objs/XGB/GSE46691_Out_XGB_MechPerformance.rda")
MechGSE41408_Out <- load("./Objs/XGB/GSE41408_Out_XGB_MechPerformance.rda")
MechJHU_Out <- load("./Objs/XGB/JHU_Out_XGB_MechPerformance.rda")
MechGSE70769_Out <- load("./Objs/XGB/GSE70769_Out_XGB_MechPerformance.rda")
...
# GSE116918_out
GSE116918_Out_XGB_AgnosticPerformance$out_study <- rep("GSE116918", nrow(GSE116918_Out_XGB_AgnosticPerformance))
GSE116918_Out_XGB_IndvGenes_AgnosticPerformance$out_study <- rep("GSE116918", nrow(GSE116918_Out_XGB_IndvGenes_AgnosticPerformance))
GSE116918_Out_XGB_MechPerformance$out_study <- rep("GSE116918", nrow(GSE116918_Out_XGB_MechPerformance))

GSE116918_Out_XGB_AgnosticPerformance$model_type <- rep("Agnostic_pairs", nrow(GSE116918_Out_XGB_AgnosticPerformance))
GSE116918_Out_XGB_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_genes", nrow(GSE116918_Out_XGB_IndvGenes_AgnosticPerformance))
GSE116918_Out_XGB_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE116918_Out_XGB_MechPerformance))

######
# GSE55935_out
GSE55935_Out_XGB_AgnosticPerformance$out_study <- rep("GSE55935", nrow(GSE55935_Out_XGB_AgnosticPerformance))
GSE55935_Out_XGB_IndvGenes_AgnosticPerformance$out_study <- rep("GSE55935", nrow(GSE55935_Out_XGB_IndvGenes_AgnosticPerformance))
GSE55935_Out_XGB_MechPerformance$out_study <- rep("GSE55935", nrow(GSE55935_Out_XGB_MechPerformance))

GSE55935_Out_XGB_AgnosticPerformance$model_type <- rep("Agnostic_pairs", nrow(GSE55935_Out_XGB_AgnosticPerformance))
GSE55935_Out_XGB_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_genes", nrow(GSE55935_Out_XGB_IndvGenes_AgnosticPerformance))
GSE55935_Out_XGB_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE55935_Out_XGB_MechPerformance))

#######
# GSE51066_out
GSE51066_Out_XGB_AgnosticPerformance$out_study <- rep("GSE51066", nrow(GSE51066_Out_XGB_AgnosticPerformance))
GSE51066_Out_XGB_IndvGenes_AgnosticPerformance$out_study <- rep("GSE51066", nrow(GSE51066_Out_XGB_IndvGenes_AgnosticPerformance))
GSE51066_Out_XGB_MechPerformance$out_study <- rep("GSE51066", nrow(GSE51066_Out_XGB_MechPerformance))

GSE51066_Out_XGB_AgnosticPerformance$model_type <- rep("Agnostic_pairs", nrow(GSE51066_Out_XGB_AgnosticPerformance))
GSE51066_Out_XGB_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_genes", nrow(GSE51066_Out_XGB_IndvGenes_AgnosticPerformance))
GSE51066_Out_XGB_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE51066_Out_XGB_MechPerformance))

#######
# GSE46691_out
GSE46691_Out_XGB_AgnosticPerformance$out_study <- rep("GSE46691", nrow(GSE46691_Out_XGB_AgnosticPerformance))
GSE46691_Out_XGB_IndvGenes_AgnosticPerformance$out_study <- rep("GSE46691", nrow(GSE46691_Out_XGB_IndvGenes_AgnosticPerformance))
GSE46691_Out_XGB_MechPerformance$out_study <- rep("GSE46691", nrow(GSE46691_Out_XGB_MechPerformance))

GSE46691_Out_XGB_AgnosticPerformance$model_type <- rep("Agnostic_pairs", nrow(GSE46691_Out_XGB_AgnosticPerformance))
GSE46691_Out_XGB_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_genes", nrow(GSE46691_Out_XGB_IndvGenes_AgnosticPerformance))
GSE46691_Out_XGB_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE46691_Out_XGB_MechPerformance))

#######
# GSE41408_out
GSE41408_Out_XGB_AgnosticPerformance$out_study <- rep("GSE41408", nrow(GSE41408_Out_XGB_AgnosticPerformance))
GSE41408_Out_XGB_IndvGenes_AgnosticPerformance$out_study <- rep("GSE41408", nrow(GSE41408_Out_XGB_IndvGenes_AgnosticPerformance))
GSE41408_Out_XGB_MechPerformance$out_study <- rep("GSE41408", nrow(GSE41408_Out_XGB_MechPerformance))

GSE41408_Out_XGB_AgnosticPerformance$model_type <- rep("Agnostic_pairs", nrow(GSE41408_Out_XGB_AgnosticPerformance))
GSE41408_Out_XGB_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_genes", nrow(GSE41408_Out_XGB_IndvGenes_AgnosticPerformance))
GSE41408_Out_XGB_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE41408_Out_XGB_MechPerformance))

#######
# JHU_out
JHU_Out_XGB_AgnosticPerformance$out_study <- rep("JHU", nrow(JHU_Out_XGB_AgnosticPerformance))
JHU_Out_XGB_IndvGenes_AgnosticPerformance$out_study <- rep("JHU", nrow(JHU_Out_XGB_IndvGenes_AgnosticPerformance))
JHU_Out_XGB_MechPerformance$out_study <- rep("JHU", nrow(JHU_Out_XGB_MechPerformance))

JHU_Out_XGB_AgnosticPerformance$model_type <- rep("Agnostic_pairs", nrow(JHU_Out_XGB_AgnosticPerformance))
JHU_Out_XGB_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_genes", nrow(JHU_Out_XGB_IndvGenes_AgnosticPerformance))
JHU_Out_XGB_MechPerformance$model_type <- rep("Mechanistic", nrow(JHU_Out_XGB_MechPerformance))

#######
# GSE70769_out
GSE70769_Out_XGB_AgnosticPerformance$out_study <- rep("GSE70769", nrow(GSE70769_Out_XGB_AgnosticPerformance))
GSE70769_Out_XGB_IndvGenes_AgnosticPerformance$out_study <- rep("GSE70769", nrow(GSE70769_Out_XGB_IndvGenes_AgnosticPerformance))
GSE70769_Out_XGB_MechPerformance$out_study <- rep("GSE70769", nrow(GSE70769_Out_XGB_MechPerformance))

GSE70769_Out_XGB_AgnosticPerformance$model_type <- rep("Agnostic_pairs", nrow(GSE70769_Out_XGB_AgnosticPerformance))
GSE70769_Out_XGB_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_genes", nrow(GSE70769_Out_XGB_IndvGenes_AgnosticPerformance))
GSE70769_Out_XGB_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE70769_Out_XGB_MechPerformance))



All_XGB_CV <- rbind(GSE116918_Out_XGB_AgnosticPerformance, GSE116918_Out_XGB_IndvGenes_AgnosticPerformance, GSE116918_Out_XGB_MechPerformance,
                    GSE55935_Out_XGB_AgnosticPerformance, GSE55935_Out_XGB_IndvGenes_AgnosticPerformance, GSE55935_Out_XGB_MechPerformance,
                    GSE51066_Out_XGB_AgnosticPerformance, GSE51066_Out_XGB_IndvGenes_AgnosticPerformance, GSE51066_Out_XGB_MechPerformance, 
                    GSE46691_Out_XGB_AgnosticPerformance, GSE46691_Out_XGB_IndvGenes_AgnosticPerformance, GSE46691_Out_XGB_MechPerformance, 
                    GSE41408_Out_XGB_AgnosticPerformance, GSE41408_Out_XGB_IndvGenes_AgnosticPerformance, GSE41408_Out_XGB_MechPerformance,
                    JHU_Out_XGB_AgnosticPerformance, JHU_Out_XGB_IndvGenes_AgnosticPerformance, JHU_Out_XGB_MechPerformance,
                    GSE70769_Out_XGB_AgnosticPerformance, GSE70769_Out_XGB_IndvGenes_AgnosticPerformance, GSE70769_Out_XGB_MechPerformance)
