...
###################
### Plot Curve
png("./Figs/XGB/LOO/CompareAUCggplot_GSE41408Out.png",
    width=3000, height=3000, res=360)
### Color
myCol <- brewer.pal(3, "Dark2")[c(2,1)]
### Plot and legend titles
plotTitle <- "AUC mechanistic vs agnostic XGB (GSE41408 for validation)"
legendTitle <- "Mechanistic VS Agnostic"
### Plot
basicplot_XGB_GSE41408Out <- ggplot(dat_XGB, aes(d=Status, m=XGB_sum, color=XGB_type,
                                                 linetype = XGB_type)) +
...
### Plot
basicplot_XGB_GSE41408Out
### Close device
dev.off()

save(basicplot_XGB_GSE41408Out, file = "./Objs/XGB/LOO/BasicPlot_XGB_GSE41408Out.rda")
