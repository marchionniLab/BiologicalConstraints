...
GSE46691_Out_XGB_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE46691_Out_XGB_AgnosticPerformance, file = "./Objs/XGB/GSE46691_Out_XGB_AgnosticPerformance.rda")
