...
GSE46691_Out_XGB_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE46691_Out_XGB_IndvGenes_AgnosticPerformance, file = "./Objs/XGB/GSE46691_Out_XGB_IndvGenes_AgnosticPerformance.rda")
