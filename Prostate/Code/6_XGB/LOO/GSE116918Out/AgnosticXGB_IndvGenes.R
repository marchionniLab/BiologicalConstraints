...
GSE116918_Out_XGB_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE116918_Out_XGB_IndvGenes_AgnosticPerformance, file = "./Objs/XGB/GSE116918_Out_XGB_IndvGenes_AgnosticPerformance.rda")
