...
GSE116918_Out_XGB_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE116918_Out_XGB_AgnosticPerformance, file = "./Objs/XGB/GSE116918_Out_XGB_AgnosticPerformance.rda")
