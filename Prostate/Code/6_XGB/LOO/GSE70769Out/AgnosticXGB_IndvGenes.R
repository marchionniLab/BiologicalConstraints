...
GSE70769_Out_XGB_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE70769_Out_XGB_IndvGenes_AgnosticPerformance, file = "./Objs/XGB/GSE70769_Out_XGB_IndvGenes_AgnosticPerformance.rda")
