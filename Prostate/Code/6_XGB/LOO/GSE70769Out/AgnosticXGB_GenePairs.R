...
GSE70769_Out_XGB_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE70769_Out_XGB_AgnosticPerformance, file = "./Objs/XGB/GSE70769_Out_XGB_AgnosticPerformance.rda")
