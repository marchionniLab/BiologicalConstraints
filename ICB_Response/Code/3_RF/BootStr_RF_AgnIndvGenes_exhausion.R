...
## Load data
load("./Objs/KTSP/KTSP_STATs_Mechanistic_exhausion.rda")
...
save(bootobjectMech, file = './objs/RF/RF_bootobjectMech_exhausion.rda')
...
save(bootobjectMech, bootobjectAgnostic_50, bootobjectAgnostic_100, bootobjectAgnostic_200, bootobjectAgnostic_500, file = "./Objs/RF/RFBootObjects_exhausion.rda")

## load
load("./Objs/RF/RFBootObjects_exhausion.rda")
