...
GSE78220_Out_RF_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE78220_Out_RF_AgnosticPerformance, file = "./Objs/RF/GSE78220_Out_RF_AgnosticPerformance.rda")
