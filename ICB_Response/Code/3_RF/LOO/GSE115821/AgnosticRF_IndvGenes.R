...
set.seed(333)
RF_Agnostic <- randomForest(x =predictor_data, y=target, importance = TRUE, ntree = 1000, mtry = 130 ,proximity=TRUE, na.action = na.omit, sampsize = sampsizes)
print(RF_Agnostic)
...
GSE115821_Out_RF_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE115821_Out_RF_IndvGenes_AgnosticPerformance, file = "./Objs/RF/GSE115821_Out_RF_IndvGenes_AgnosticPerformance.rda")
