...
set.seed(333)
RF_Mechanistic_OnKTSP <- randomForest(x =predictor_data, y=usedTrainGroup, importance = TRUE, ntree = 50, mtry = 20, proximity=TRUE, na.action = na.omit, sampsize = sampsizes)
...
GSE115821_Out_RF_MechPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE115821_Out_RF_MechPerformance, file = "./Objs/RF/GSE115821_Out_RF_MechPerformance.rda")
