...
TCGA_Out_RF_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(TCGA_Out_RF_IndvGenes_AgnosticPerformance, file = "./Objs/RF/TCGA_Out_RF_IndvGenes_AgnosticPerformance.rda")
