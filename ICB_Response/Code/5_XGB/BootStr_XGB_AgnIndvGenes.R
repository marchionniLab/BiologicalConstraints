...
### Save boot objects
save(bootobjectMech, bootobjectAgnostic_50, bootobjectAgnostic_100, bootobjectAgnostic_200, bootobjectAgnostic_500, file = "./Objs/XGB/XGBBootObjects.rda")
...
range(AUCs_XG_Mech[, 'AUC_Test'])
range(AUCs_XGB_Agnostic_50[, 'AUC_Test'])
