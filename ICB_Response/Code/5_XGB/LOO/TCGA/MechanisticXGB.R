...
## Load data
load("./Objs/KTSP/KTSP_STATs_Mechanistic_TCGAOut.rda")
...
TCGA_Out_XGB_MechPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(TCGA_Out_XGB_MechPerformance, file = "./Objs/XGB/TCGA_Out_XGB_MechPerformance.rda")
