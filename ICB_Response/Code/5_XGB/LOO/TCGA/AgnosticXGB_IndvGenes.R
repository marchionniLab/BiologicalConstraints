...
TCGA_Out_XGB_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(TCGA_Out_XGB_IndvGenes_AgnosticPerformance, file = "./Objs/XGB/TCGA_Out_XGB_IndvGenes_AgnosticPerformance.rda")
