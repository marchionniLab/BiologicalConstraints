...
GSE78220_Out_XGB_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE78220_Out_XGB_AgnosticPerformance, file = "./Objs/XGB/GSE78220_Out_XGB_AgnosticPerformance.rda")
