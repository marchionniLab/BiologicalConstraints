...
GSE78220_Out_XGB_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE78220_Out_XGB_IndvGenes_AgnosticPerformance, file = "./Objs/XGB/GSE78220_Out_XGB_IndvGenes_AgnosticPerformance.rda")
