...
VanAllen_Out_XGB_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(VanAllen_Out_XGB_AgnosticPerformance, file = "./Objs/XGB/VanAllen_Out_XGB_AgnosticPerformance.rda")
