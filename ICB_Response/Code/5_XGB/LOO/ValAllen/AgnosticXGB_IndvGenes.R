...
VanAllen_Out_XGB_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(VanAllen_Out_XGB_IndvGenes_AgnosticPerformance, file = "./Objs/XGB/VanAllen_Out_XGB_IndvGenes_AgnosticPerformance.rda")
