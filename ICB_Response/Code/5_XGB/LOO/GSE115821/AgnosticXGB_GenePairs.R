...
xgb.agnostic_OnKTSP <- xgb.train(parameters, DataTrain, nrounds = 500, watchlist,  early_stopping_rounds = 50, scale_pos_weight = R/NR)
...
GSE115821_Out_XGB_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE115821_Out_XGB_AgnosticPerformance, file = "./Objs/XGB/GSE115821_Out_XGB_AgnosticPerformance.rda")
