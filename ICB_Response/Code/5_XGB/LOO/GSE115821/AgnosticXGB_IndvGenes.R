...
GSE115821_Out_XGB_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE115821_Out_XGB_IndvGenes_AgnosticPerformance, file = "./Objs/XGB/GSE115821_Out_XGB_IndvGenes_AgnosticPerformance.rda")
