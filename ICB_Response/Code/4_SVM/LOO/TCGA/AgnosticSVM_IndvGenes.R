...
TCGA_Out_SVM_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(TCGA_Out_SVM_IndvGenes_AgnosticPerformance, file = "./Objs/SVM/TCGA_Out_SVM_IndvGenes_AgnosticPerformance.rda")
