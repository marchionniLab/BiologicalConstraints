...
Grid <- expand.grid(degree = 2, scale = 0.01, C = 1)
set.seed(333)
...
VanAllen_Out_SVM_MechPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(VanAllen_Out_SVM_MechPerformance, file = "./Objs/SVM/VanAllen_Out_SVM_MechPerformance.rda")
