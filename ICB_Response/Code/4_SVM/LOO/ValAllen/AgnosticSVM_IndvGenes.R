...
# Best threshold
thr <- coords(roc(usedTrainGroup, train_pred_prob_svmPoly_agnostic[,2], levels = c("NR", "R")), "best")["threshold"]
thr <- thr$threshold
thr
...
VanAllen_Out_SVM_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(VanAllen_Out_SVM_IndvGenes_AgnosticPerformance, file = "./Objs/SVM/VanAllen_Out_SVM_IndvGenes_AgnosticPerformance.rda")
