...
VanAllen_Out_SVM_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(VanAllen_Out_SVM_AgnosticPerformance, file = "./Objs/SVM/VanAllen_Out_SVM_AgnosticPerformance.rda")
