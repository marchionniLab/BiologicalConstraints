...
GSE115821_Out_SVM_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE115821_Out_SVM_IndvGenes_AgnosticPerformance, file = "./Objs/SVM/GSE115821_Out_SVM_IndvGenes_AgnosticPerformance.rda")
