...
## Agnostic
load("./Objs/KTSP/KTSP_STATs_Agnostic_GSE115821Out.rda")
...
GSE115821_Out_SVM_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE115821_Out_SVM_AgnosticPerformance, file = "./Objs/SVM/GSE115821_Out_SVM_AgnosticPerformance.rda")
