...
Grid <- expand.grid(degree = 1, scale = 0.01, C = 1)
set.seed(333)
...
GSE91061_Out_SVM_MechPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE91061_Out_SVM_MechPerformance, file = "./Objs/SVM/GSE91061_Out_SVM_MechPerformance.rda")
