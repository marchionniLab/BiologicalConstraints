...
Grid <- expand.grid(degree = 1, scale = 0.01, C = 0.5)
set.seed(333)
...
GSE78220_Out_SVM_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE78220_Out_SVM_AgnosticPerformance, file = "./Objs/SVM/GSE78220_Out_SVM_AgnosticPerformance.rda")
