...
# Best threshold
thr <- coords(roc(usedTrainGroup, train_pred_prob_svmPoly_agnostic[,1], levels = c("NR", "R")), "best")["threshold"]
thr <- thr$threshold
thr
...
GSE78220_Out_SVM_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE78220_Out_SVM_IndvGenes_AgnosticPerformance, file = "./Objs/SVM/GSE78220_Out_SVM_IndvGenes_AgnosticPerformance.rda")
