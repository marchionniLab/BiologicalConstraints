...
AllModelCompare_Breast_DiffNoFeat <- rbind(ModelCompare_KTSP_DiffNoFeat, ModelCompare_RF_RAND_DiffNoFeat, ModelCompare_SVM_RAND_DiffNoFeat, ModelCompare_XGB_RAND_DiffNoFeat)

AllModelCompare_Breast_DiffNoFeat$data_type <- factor(AllModelCompare_Breast_DiffNoFeat$data_type, levels = c("Training", "Testing"))

AllModelCompare_Breast_DiffNoFeat$modelType <- factor(AllModelCompare_Breast_DiffNoFeat$modelType, levels = c("Random_genes", "Mechanistic"))

levels(AllModelCompare_Breast_DiffNoFeat$modelType) <- c("Random genes", "Mechanistic")
...
sel <- which(AllModelCompare_Breast_DiffNoFeat$algorithm == "K-TSPs" & AllModelCompare_Breast_DiffNoFeat$modelType == "Mechanistic" & AllModelCompare_Breast_DiffNoFeat$NofFeatAgn != "241_Pairs")
...
## Density plot
png(filename = "./Figs/Breast_BS_AllModels_Density_DiffNoFeatAndPairs_RAND.png", width = 3000, height = 1500, res = 200)
