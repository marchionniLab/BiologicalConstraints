...
### Save boot objects
save(bootobjectMech, bootobjectAgnostic_25, bootobjectAgnostic_50, bootobjectAgnostic_100, bootobjectAgnostic_250, file = "./Objs/XGB/XGBBootObjects_NotchAndMyc_AgnPairs_new.rda")

# Load
load("./Objs/XGB/XGBBootObjects_NotchAndMyc_AgnPairs_new.rda")
