...
GSE103668_Out_XGB_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE103668_Out_XGB_AgnosticPerformance, file = "./Objs/XGB/GSE103668_Out_XGB_AgnosticPerformance.rda")
