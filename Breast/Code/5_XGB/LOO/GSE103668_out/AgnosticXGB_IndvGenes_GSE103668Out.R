...
GSE103668_Out_XGB_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE103668_Out_XGB_IndvGenes_AgnosticPerformance, file = "./Objs/XGB/GSE103668_Out_XGB_IndvGenes_AgnosticPerformance.rda")
