...
GSE20271_Out_XGB_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE20271_Out_XGB_IndvGenes_AgnosticPerformance, file = "./Objs/XGB/GSE20271_Out_XGB_IndvGenes_AgnosticPerformance.rda")
