...
GSE20271_Out_XGB_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE20271_Out_XGB_AgnosticPerformance, file = "./Objs/XGB/GSE20271_Out_XGB_AgnosticPerformance.rda")
