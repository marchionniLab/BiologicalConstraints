...
GSE32646_Out_XGB_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE32646_Out_XGB_AgnosticPerformance, file = "./Objs/XGB/GSE32646_Out_XGB_AgnosticPerformance.rda")
