...
GSE32646_Out_XGB_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE32646_Out_XGB_IndvGenes_AgnosticPerformance, file = "./Objs/XGB/GSE32646_Out_XGB_IndvGenes_AgnosticPerformance.rda")
