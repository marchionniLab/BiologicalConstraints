...
AgnosticGSE25055_Out <- load("./Objs/XGB/GSE25055_Out_XGB_AgnosticPerformance.rda")
AgnosticGSE25065_Out <- load("./Objs/XGB/GSE25065_Out_XGB_AgnosticPerformance.rda")
AgnosticGSE140494_Out <- load("./Objs/XGB/GSE140494_Out_XGB_AgnosticPerformance.rda")
AgnosticGSE103668_Out <- load("./Objs/XGB/GSE103668_Out_XGB_AgnosticPerformance.rda")
AgnosticGSE20194_Out <- load("./Objs/XGB/GSE20194_Out_XGB_AgnosticPerformance.rda")
AgnosticGSE20271_Out <- load("./Objs/XGB/GSE20271_Out_XGB_AgnosticPerformance.rda")
AgnosticGSE32646_Out <- load("./Objs/XGB/GSE32646_Out_XGB_AgnosticPerformance.rda")
...
GSE25055_Out_XGB_AgnosticPerformance$model_type <- rep("Agnostic", nrow(GSE25055_Out_XGB_AgnosticPerformance))
...
GSE25065_Out_XGB_AgnosticPerformance$model_type <- rep("Agnostic", nrow(GSE25065_Out_XGB_AgnosticPerformance))
...
GSE140494_Out_XGB_AgnosticPerformance$model_type <- rep("Agnostic", nrow(GSE140494_Out_XGB_AgnosticPerformance))
...
GSE103668_Out_XGB_AgnosticPerformance$model_type <- rep("Agnostic", nrow(GSE103668_Out_XGB_AgnosticPerformance))
...
GSE20194_Out_XGB_AgnosticPerformance$model_type <- rep("Agnostic", nrow(GSE20194_Out_XGB_AgnosticPerformance))
...
GSE20271_Out_XGB_AgnosticPerformance$model_type <- rep("Agnostic", nrow(GSE20271_Out_XGB_AgnosticPerformance))
...
GSE32646_Out_XGB_AgnosticPerformance$model_type <- rep("Agnostic", nrow(GSE32646_Out_XGB_AgnosticPerformance))
GSE32646_Out_XGB_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE32646_Out_XGB_MechPerformance))



All_XGB_CV <- rbind(GSE25055_Out_XGB_AgnosticPerformance, GSE25055_Out_XGB_MechPerformance,
                    GSE25065_Out_XGB_AgnosticPerformance, GSE25065_Out_XGB_MechPerformance,
                    GSE140494_Out_XGB_AgnosticPerformance, GSE140494_Out_XGB_MechPerformance, 
                    GSE103668_Out_XGB_AgnosticPerformance, GSE103668_Out_XGB_MechPerformance, 
                    GSE20194_Out_XGB_AgnosticPerformance, GSE20194_Out_XGB_MechPerformance,
                    GSE20271_Out_XGB_AgnosticPerformance, GSE20271_Out_XGB_MechPerformance,
                    GSE32646_Out_XGB_AgnosticPerformance, GSE32646_Out_XGB_MechPerformance)
...
MeanAUC_Agnostic <-  apply(All_XGB_CV %>%
...
SD_AUC_Agnostic <-  apply(All_XGB_CV %>%
                            filter(model_type == "Agnostic") %>%
                            filter(metric == "AUC") %>%
...
MeanAccuracy_Agnostic <-  apply(All_XGB_CV %>%
                                  filter(model_type == "Agnostic") %>%
                                  filter(metric == "Accuracy") %>%
                                  select(c("Training", "Testing")), 2, mean)

# Accuracy SD in both the training and testing data
SD_Accuracy_Agnostic <-  apply(All_XGB_CV %>%
                                 filter(model_type == "Agnostic") %>%
                                 filter(metric == "Accuracy") %>%
                                 select(c("Training", "Testing")), 2, sd)
...
MeanSensitivity_Agnostic <-  apply(All_XGB_CV %>%
                                     filter(model_type == "Agnostic") %>%
                                     filter(metric == "Sensitivity") %>%
                                     select(c("Training", "Testing")), 2, mean)

# Sensitivity SD in both the training and testing data
SD_Sensitivity_Agnostic <-  apply(All_XGB_CV %>%
                                    filter(model_type == "Agnostic") %>%
                                    filter(metric == "Sensitivity") %>%
                                    select(c("Training", "Testing")), 2, sd)
...
MeanSpecificity_Agnostic <-  apply(All_XGB_CV %>%
                                     filter(model_type == "Agnostic") %>%
                                     filter(metric == "Specificity") %>%
                                     select(c("Training", "Testing")), 2, mean)

# Specificity SD in both the training and testing data
SD_Specificity_Agnostic <-  apply(All_XGB_CV %>%
                                    filter(model_type == "Agnostic") %>%
                                    filter(metric == "Specificity") %>%
                                    select(c("Training", "Testing")), 2, sd)
...
MeanMCC_Agnostic <-  apply(All_XGB_CV %>%
                             filter(model_type == "Agnostic") %>%
                             filter(metric == "MCC") %>%
                             select(c("Training", "Testing")), 2, mean)

# MCC SD in both the training and testing data
SD_MCC_Agnostic <-  apply(All_XGB_CV %>%
                            filter(model_type == "Agnostic") %>%
                            filter(metric == "MCC") %>%
                            select(c("Training", "Testing")), 2, sd)
