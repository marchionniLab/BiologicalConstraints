...
AgnosticGSE25055_Out_pairs <- load("./Objs/XGB/GSE25055_Out_XGB_AgnosticPerformance.rda")
AgnosticGSE25065_Out_pairs <- load("./Objs/XGB/GSE25065_Out_XGB_AgnosticPerformance.rda")
AgnosticGSE140494_Out_pairs <- load("./Objs/XGB/GSE140494_Out_XGB_AgnosticPerformance.rda")
AgnosticGSE103668_Out_pairs <- load("./Objs/XGB/GSE103668_Out_XGB_AgnosticPerformance.rda")
AgnosticGSE20194_Out_pairs <- load("./Objs/XGB/GSE20194_Out_XGB_AgnosticPerformance.rda")
AgnosticGSE20271_Out_pairs <- load("./Objs/XGB/GSE20271_Out_XGB_AgnosticPerformance.rda")
AgnosticGSE32646_Out_pairs <- load("./Objs/XGB/GSE32646_Out_XGB_AgnosticPerformance.rda")

# Load the agnostic genes models
AgnosticGSE25055_Out_indvGenes <- load("./Objs/XGB/GSE25055_Out_XGB_indvGenes_AgnosticPerformance.rda")
AgnosticGSE25065_Out_indvGenes <- load("./Objs/XGB/GSE25065_Out_XGB_indvGenes_AgnosticPerformance.rda")
AgnosticGSE140494_Out_indvGenes <- load("./Objs/XGB/GSE140494_Out_XGB_indvGenes_AgnosticPerformance.rda")
AgnosticGSE103668_Out_indvGenes <- load("./Objs/XGB/GSE103668_Out_XGB_indvGenes_AgnosticPerformance.rda")
AgnosticGSE20194_Out_indvGenes <- load("./Objs/XGB/GSE20194_Out_XGB_indvGenes_AgnosticPerformance.rda")
AgnosticGSE20271_Out_indvGenes <- load("./Objs/XGB/GSE20271_Out_XGB_indvGenes_AgnosticPerformance.rda")
AgnosticGSE32646_Out_indvGenes <- load("./Objs/XGB/GSE32646_Out_XGB_indvGenes_AgnosticPerformance.rda")

# Load the Mech models
MechGSE25055_Out <- load("./Objs/XGB/GSE25055_Out_XGB_MechPerformance.rda")
MechGSE25065_Out <- load("./Objs/XGB/GSE25065_Out_XGB_MechPerformance.rda")
MechGSEGSE140494_Out <- load("./Objs/XGB/GSE140494_Out_XGB_MechPerformance.rda")
MechGSE103668_Out <- load("./Objs/XGB/GSE103668_Out_XGB_MechPerformance.rda")
MechGSE20194_Out <- load("./Objs/XGB/GSE20194_Out_XGB_MechPerformance.rda")
MechGSE20271_Out <- load("./Objs/XGB/GSE20271_Out_XGB_MechPerformance.rda")
MechGSE32646_Out <- load("./Objs/XGB/GSE32646_Out_XGB_MechPerformance.rda")




# # Mean and SD of the Agnostic AUC in the training data
# MeanAUCTrainingAgnostic <- mean(c(EMTAB_Out_XGB_AgnosticPerformance$Training[1], 
#                         GSE13507_Out_XGB_AgnosticPerformance$Training[1],
#                         GSE32894_Out_XGB_AgnosticPerformance$Training[1],
#                         GSE57813_Out_XGB_AgnosticPerformance$Training[1],
#                         PMID_Out_XGB_AgnosticPerformance$Training[1]
#                         ))
# 
# SDAUCTrainingAgnostic <- sd(c(EMTAB_Out_XGB_AgnosticPerformance$Training[1], 
#                           GSE13507_Out_XGB_AgnosticPerformance$Training[1],
#                           GSE32894_Out_XGB_AgnosticPerformance$Training[1],
#                           GSE57813_Out_XGB_AgnosticPerformance$Training[1],
#                           PMID_Out_XGB_AgnosticPerformance$Training[1]
...
# MeanAUCTestingAgnostic <- mean(c(EMTAB_Out_XGB_AgnosticPerformance$Testing[1], 
#                          GSE13507_Out_XGB_AgnosticPerformance$Testing[1],
#                          GSE32894_Out_XGB_AgnosticPerformance$Testing[1],
#                          GSE57813_Out_XGB_AgnosticPerformance$Testing[1],
#                          PMID_Out_XGB_AgnosticPerformance$Testing[1]
#                         ))
# 
# 
# SDAUCTestingAgnostic <- sd(c(EMTAB_Out_XGB_AgnosticPerformance$Testing[1], 
#                                  GSE13507_Out_XGB_AgnosticPerformance$Testing[1],
#                                  GSE32894_Out_XGB_AgnosticPerformance$Testing[1],
#                                  GSE57813_Out_XGB_AgnosticPerformance$Testing[1],
#                                  PMID_Out_XGB_AgnosticPerformance$Testing[1]
...
##############################################################
## Mech XGB Average performance


# Mean and SD of the Mechanistic AUC in the training data
# MeanAUCTrainingMech <- mean(c(EMTAB_Out_XGB_MechPerformance$Training[1], 
#                                   GSE13507_Out_XGB_MechPerformance$Training[1],
#                                   GSE32894_Out_XGB_MechPerformance$Training[1],
#                                   GSE57813_Out_XGB_MechPerformance$Training[1],
#                                   PMID_Out_XGB_MechPerformance$Training[1]
#                         ))
# 
# SDAUCTrainingMech <- sd(c(EMTAB_Out_XGB_MechPerformance$Training[1], 
#                               GSE13507_Out_XGB_MechPerformance$Training[1],
#                               GSE32894_Out_XGB_MechPerformance$Training[1],
#                               GSE57813_Out_XGB_MechPerformance$Training[1],
#                               PMID_Out_XGB_MechPerformance$Training[1]
...
# 
# # Mean and SD of the Mechanistic AUC in the training data
# MeanAUCTestingMech <- mean(c(EMTAB_Out_XGB_MechPerformance$Testing[1], 
#                                  GSE13507_Out_XGB_MechPerformance$Testing[1],
#                                  GSE32894_Out_XGB_MechPerformance$Testing[1],
#                                  GSE57813_Out_XGB_MechPerformance$Testing[1],
#                                  PMID_Out_XGB_MechPerformance$Testing[1]
#                         ))
# 
# 
# SDAUCTestingMech <- sd(c(EMTAB_Out_XGB_MechPerformance$Testing[1], 
#                              GSE13507_Out_XGB_MechPerformance$Testing[1],
#                              GSE32894_Out_XGB_MechPerformance$Testing[1],
#                              GSE57813_Out_XGB_MechPerformance$Testing[1],
#                              PMID_Out_XGB_MechPerformance$Testing[1]
...
# GSE25055_out
GSE25055_Out_XGB_AgnosticPerformance$out_study <- rep("GSE25055", nrow(GSE25055_Out_XGB_AgnosticPerformance))
GSE25055_Out_XGB_IndvGenes_AgnosticPerformance$out_study <- rep("GSE25055", nrow(GSE25055_Out_XGB_IndvGenes_AgnosticPerformance))
GSE25055_Out_XGB_MechPerformance$out_study <- rep("GSE25055", nrow(GSE25055_Out_XGB_MechPerformance))

GSE25055_Out_XGB_AgnosticPerformance$model_type <- rep("Agnostic_pairs", nrow(GSE25055_Out_XGB_AgnosticPerformance))
GSE25055_Out_XGB_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_genes", nrow(GSE25055_Out_XGB_IndvGenes_AgnosticPerformance))
GSE25055_Out_XGB_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE25055_Out_XGB_MechPerformance))

##############
# GSE25065_out
GSE25065_Out_XGB_AgnosticPerformance$out_study <- rep("GSE25065", nrow(GSE25065_Out_XGB_AgnosticPerformance))
GSE25065_Out_XGB_IndvGenes_AgnosticPerformance$out_study <- rep("GSE25065", nrow(GSE25065_Out_XGB_IndvGenes_AgnosticPerformance))
GSE25065_Out_XGB_MechPerformance$out_study <- rep("GSE25065", nrow(GSE25065_Out_XGB_MechPerformance))

GSE25065_Out_XGB_AgnosticPerformance$model_type <- rep("Agnostic_pairs", nrow(GSE25065_Out_XGB_AgnosticPerformance))
GSE25065_Out_XGB_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_genes", nrow(GSE25065_Out_XGB_IndvGenes_AgnosticPerformance))
GSE25065_Out_XGB_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE25065_Out_XGB_MechPerformance))

##############
# GSE140494_out
GSE140494_Out_XGB_AgnosticPerformance$out_study <- rep("GSE140494", nrow(GSE140494_Out_XGB_AgnosticPerformance))
GSE140494_Out_XGB_IndvGenes_AgnosticPerformance$out_study <- rep("GSE140494", nrow(GSE140494_Out_XGB_IndvGenes_AgnosticPerformance))
GSE140494_Out_XGB_MechPerformance$out_study <- rep("GSE140494", nrow(GSE140494_Out_XGB_MechPerformance))

GSE140494_Out_XGB_AgnosticPerformance$model_type <- rep("Agnostic_pairs", nrow(GSE140494_Out_XGB_AgnosticPerformance))
GSE140494_Out_XGB_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_genes", nrow(GSE140494_Out_XGB_IndvGenes_AgnosticPerformance))
GSE140494_Out_XGB_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE140494_Out_XGB_MechPerformance))

###############
# GSE103668_out
GSE103668_Out_XGB_AgnosticPerformance$out_study <- rep("GSE103668", nrow(GSE103668_Out_XGB_AgnosticPerformance))
GSE103668_Out_XGB_IndvGenes_AgnosticPerformance$out_study <- rep("GSE103668", nrow(GSE103668_Out_XGB_IndvGenes_AgnosticPerformance))
GSE103668_Out_XGB_MechPerformance$out_study <- rep("GSE103668", nrow(GSE103668_Out_XGB_MechPerformance))

GSE103668_Out_XGB_AgnosticPerformance$model_type <- rep("Agnostic_pairs", nrow(GSE103668_Out_XGB_AgnosticPerformance))
GSE103668_Out_XGB_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_genes", nrow(GSE103668_Out_XGB_IndvGenes_AgnosticPerformance))
GSE103668_Out_XGB_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE103668_Out_XGB_MechPerformance))

##############
# GSE20194_out
GSE20194_Out_XGB_AgnosticPerformance$out_study <- rep("GSE20194", nrow(GSE20194_Out_XGB_AgnosticPerformance))
GSE20194_Out_XGB_IndvGenes_AgnosticPerformance$out_study <- rep("GSE20194", nrow(GSE20194_Out_XGB_IndvGenes_AgnosticPerformance))
GSE20194_Out_XGB_MechPerformance$out_study <- rep("GSE20194", nrow(GSE20194_Out_XGB_MechPerformance))

GSE20194_Out_XGB_AgnosticPerformance$model_type <- rep("Agnostic_pairs", nrow(GSE20194_Out_XGB_AgnosticPerformance))
GSE20194_Out_XGB_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_genes", nrow(GSE20194_Out_XGB_IndvGenes_AgnosticPerformance))
GSE20194_Out_XGB_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE20194_Out_XGB_MechPerformance))

##############
# GSE20271_out
GSE20271_Out_XGB_AgnosticPerformance$out_study <- rep("GSE20271", nrow(GSE20271_Out_XGB_AgnosticPerformance))
GSE20271_Out_XGB_IndvGenes_AgnosticPerformance$out_study <- rep("GSE20271", nrow(GSE20271_Out_XGB_IndvGenes_AgnosticPerformance))
GSE20271_Out_XGB_MechPerformance$out_study <- rep("GSE20271", nrow(GSE20271_Out_XGB_MechPerformance))

GSE20271_Out_XGB_AgnosticPerformance$model_type <- rep("Agnostic_pairs", nrow(GSE20271_Out_XGB_AgnosticPerformance))
GSE20271_Out_XGB_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_genes", nrow(GSE20271_Out_XGB_IndvGenes_AgnosticPerformance))
GSE20271_Out_XGB_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE20271_Out_XGB_MechPerformance))

#############
# GSE32646_out
GSE32646_Out_XGB_AgnosticPerformance$out_study <- rep("GSE32646", nrow(GSE32646_Out_XGB_AgnosticPerformance))
GSE32646_Out_XGB_IndvGenes_AgnosticPerformance$out_study <- rep("GSE32646", nrow(GSE32646_Out_XGB_IndvGenes_AgnosticPerformance))
GSE32646_Out_XGB_MechPerformance$out_study <- rep("GSE32646", nrow(GSE32646_Out_XGB_MechPerformance))

GSE32646_Out_XGB_AgnosticPerformance$model_type <- rep("Agnostic_pairs", nrow(GSE32646_Out_XGB_AgnosticPerformance))
GSE32646_Out_XGB_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_genes", nrow(GSE32646_Out_XGB_IndvGenes_AgnosticPerformance))
GSE32646_Out_XGB_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE32646_Out_XGB_MechPerformance))


###############
All_XGB_CV <- rbind(GSE25055_Out_XGB_AgnosticPerformance, GSE25055_Out_XGB_IndvGenes_AgnosticPerformance, GSE25055_Out_XGB_MechPerformance,
                    GSE25065_Out_XGB_AgnosticPerformance, GSE25065_Out_XGB_IndvGenes_AgnosticPerformance, GSE25065_Out_XGB_MechPerformance,
                    GSE140494_Out_XGB_AgnosticPerformance, GSE140494_Out_XGB_IndvGenes_AgnosticPerformance, GSE140494_Out_XGB_MechPerformance, 
                    GSE103668_Out_XGB_AgnosticPerformance, GSE103668_Out_XGB_IndvGenes_AgnosticPerformance, GSE103668_Out_XGB_MechPerformance, 
                    GSE20194_Out_XGB_AgnosticPerformance, GSE20194_Out_XGB_IndvGenes_AgnosticPerformance, GSE20194_Out_XGB_MechPerformance,
                    GSE20271_Out_XGB_AgnosticPerformance, GSE20271_Out_XGB_IndvGenes_AgnosticPerformance, GSE20271_Out_XGB_MechPerformance,
                    GSE32646_Out_XGB_AgnosticPerformance, GSE32646_Out_XGB_IndvGenes_AgnosticPerformance, GSE32646_Out_XGB_MechPerformance)
