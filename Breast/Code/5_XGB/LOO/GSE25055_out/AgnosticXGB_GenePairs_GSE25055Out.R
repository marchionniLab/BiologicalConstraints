...
GSE25055_Out_XGB_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE25055_Out_XGB_AgnosticPerformance, file = "./Objs/XGB/GSE25055_Out_XGB_AgnosticPerformance.rda")
