...
GSE25055_Out_XGB_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE25055_Out_XGB_IndvGenes_AgnosticPerformance, file = "./Objs/XGB/GSE25055_Out_XGB_IndvGenes_AgnosticPerformance.rda")
