...
GSE140494_Out_XGB_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE140494_Out_XGB_IndvGenes_AgnosticPerformance, file = "./Objs/XGB/GSE140494_Out_XGB_IndvGenes_AgnosticPerformance.rda")
