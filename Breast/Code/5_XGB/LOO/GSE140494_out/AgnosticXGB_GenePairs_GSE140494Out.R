...
GSE140494_Out_XGB_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE140494_Out_XGB_AgnosticPerformance, file = "./Objs/XGB/GSE140494_Out_XGB_AgnosticPerformance.rda")
