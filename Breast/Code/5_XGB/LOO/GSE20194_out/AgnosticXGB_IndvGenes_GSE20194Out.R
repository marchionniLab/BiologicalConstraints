...
GSE20194_Out_XGB_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE20194_Out_XGB_IndvGenes_AgnosticPerformance, file = "./Objs/XGB/GSE20194_Out_XGB_IndvGenes_AgnosticPerformance.rda")
