...
AgnosticGSE25055_Out <- load("./Objs/KTSP/GSE25055_Out_AgnosticPerformance.rda")
AgnosticGSE25065_Out <- load("./Objs/KTSP/GSE25065_Out_AgnosticPerformance.rda")
AgnosticGSE140494_Out <- load("./Objs/KTSP/GSE140494_Out_AgnosticPerformance.rda")
AgnosticGSE103668_Out <- load("./Objs/KTSP/GSE103668_Out_AgnosticPerformance.rda")
AgnosticGSE20194_Out <- load("./Objs/KTSP/GSE20194_Out_AgnosticPerformance.rda")
AgnosticGSE20271_Out <- load("./Objs/KTSP/GSE20271_Out_AgnosticPerformance.rda")
AgnosticGSE32646_Out <- load("./Objs/KTSP/GSE32646_Out_AgnosticPerformance.rda")

# Load the Mech models
MechGSE25055_Out <- load("./Objs/KTSP/GSE25055_Out_MechPerformance.rda")
MechGSE25065_Out <- load("./Objs/KTSP/GSE25065_Out_MechPerformance.rda")
MechGSEGSE140494_Out <- load("./Objs/KTSP/GSE140494_Out_MechPerformance.rda")
MechGSE103668_Out <- load("./Objs/KTSP/GSE103668_Out_MechPerformance.rda")
MechGSE20194_Out <- load("./Objs/KTSP/GSE20194_Out_MechPerformance.rda")
MechGSE20271_Out <- load("./Objs/KTSP/GSE20271_Out_MechPerformance.rda")
MechGSE32646_Out <- load("./Objs/KTSP/GSE32646_Out_MechPerformance.rda")
...
# GSE25055_out
GSE25055_Out_AgnosticPerformance$out_study <- rep("GSE25055", nrow(GSE25055_Out_AgnosticPerformance))
GSE25055_Out_MechPerformance$out_study <- rep("GSE25055", nrow(GSE25055_Out_MechPerformance))
GSE25055_Out_AgnosticPerformance$model_type <- rep("Agnostic", nrow(GSE25055_Out_AgnosticPerformance))
GSE25055_Out_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE25055_Out_MechPerformance))

# GSE25065_out
GSE25065_Out_AgnosticPerformance$out_study <- rep("GSE25065", nrow(GSE25065_Out_AgnosticPerformance))
GSE25065_Out_MechPerformance$out_study <- rep("GSE25065", nrow(GSE25065_Out_MechPerformance))
GSE25065_Out_AgnosticPerformance$model_type <- rep("Agnostic", nrow(GSE25065_Out_AgnosticPerformance))
GSE25065_Out_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE25065_Out_MechPerformance))

# GSE140494_out
GSE140494_Out_AgnosticPerformance$out_study <- rep("GSE140494", nrow(GSE140494_Out_AgnosticPerformance))
GSE140494_Out_MechPerformance$out_study <- rep("GSE140494", nrow(GSE140494_Out_MechPerformance))
GSE140494_Out_AgnosticPerformance$model_type <- rep("Agnostic", nrow(GSE140494_Out_AgnosticPerformance))
GSE140494_Out_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE140494_Out_MechPerformance))

# GSE103668_out
GSE103668_Out_AgnosticPerformance$out_study <- rep("GSE103668", nrow(GSE103668_Out_AgnosticPerformance))
GSE103668_Out_MechPerformance$out_study <- rep("GSE103668", nrow(GSE103668_Out_MechPerformance))
GSE103668_Out_AgnosticPerformance$model_type <- rep("Agnostic", nrow(GSE103668_Out_AgnosticPerformance))
GSE103668_Out_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE103668_Out_MechPerformance))

# GSE20194_out
GSE20194_Out_AgnosticPerformance$out_study <- rep("GSE20194", nrow(GSE20194_Out_AgnosticPerformance))
GSE20194_Out_MechPerformance$out_study <- rep("GSE20194", nrow(GSE20194_Out_MechPerformance))
GSE20194_Out_AgnosticPerformance$model_type <- rep("Agnostic", nrow(GSE20194_Out_AgnosticPerformance))
GSE20194_Out_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE20194_Out_MechPerformance))

# GSE20271_out
GSE20271_Out_AgnosticPerformance$out_study <- rep("GSE20271", nrow(GSE20271_Out_AgnosticPerformance))
GSE20271_Out_MechPerformance$out_study <- rep("GSE20271", nrow(GSE20271_Out_MechPerformance))
GSE20271_Out_AgnosticPerformance$model_type <- rep("Agnostic", nrow(GSE20271_Out_AgnosticPerformance))
GSE20271_Out_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE20271_Out_MechPerformance))

# GSE32646_out
GSE32646_Out_AgnosticPerformance$out_study <- rep("GSE32646", nrow(GSE32646_Out_AgnosticPerformance))
GSE32646_Out_MechPerformance$out_study <- rep("GSE32646", nrow(GSE32646_Out_MechPerformance))
GSE32646_Out_AgnosticPerformance$model_type <- rep("Agnostic", nrow(GSE32646_Out_AgnosticPerformance))
GSE32646_Out_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE32646_Out_MechPerformance))



All_KTSP_CV <- rbind(GSE25055_Out_AgnosticPerformance, GSE25055_Out_MechPerformance,
                     GSE25065_Out_AgnosticPerformance, GSE25065_Out_MechPerformance,
                     GSE140494_Out_AgnosticPerformance, GSE140494_Out_MechPerformance, 
                     GSE103668_Out_AgnosticPerformance, GSE103668_Out_MechPerformance, 
                     GSE20194_Out_AgnosticPerformance, GSE20194_Out_MechPerformance,
                     GSE20271_Out_AgnosticPerformance, GSE20271_Out_MechPerformance,
                     GSE32646_Out_AgnosticPerformance, GSE32646_Out_MechPerformance)
