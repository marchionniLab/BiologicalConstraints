...
GSE25055_Out_SVM_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE25055_Out_SVM_AgnosticPerformance, file = "./Objs/SVM/GSE25055_Out_SVM_AgnosticPerformance.rda")
