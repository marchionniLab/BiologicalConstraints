...
## Load data
load("./Objs/KTSP/KTSP_STATs_Mechanistic_GSE25055Out.rda")
...
GSE25055_Out_SVM_MechPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE25055_Out_SVM_MechPerformance, file = "./Objs/SVM/GSE25055_Out_SVM_MechPerformance.rda")
