...
Grid <- expand.grid(degree = 1, scale = 0.1, C = 0.25)
set.seed(333)
...
GSE25055_Out_SVM_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE25055_Out_SVM_IndvGenes_AgnosticPerformance, file = "./Objs/SVM/GSE25055_Out_SVM_IndvGenes_AgnosticPerformance.rda")
