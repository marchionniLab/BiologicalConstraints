...
## Load data
load("./Objs/KTSP/KTSP_STATs_Mechanistic_GSE32646Out.rda")
load("./Objs/ChemoDataNew_GSE32646Out.rda")
...
GSE32646_Out_SVM_MechPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE32646_Out_SVM_MechPerformance, file = "./Objs/SVM/GSE32646_Out_SVM_MechPerformance.rda")
