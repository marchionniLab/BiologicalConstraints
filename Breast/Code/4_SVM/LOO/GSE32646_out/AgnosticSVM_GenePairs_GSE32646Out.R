...
GSE32646_Out_SVM_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE32646_Out_SVM_AgnosticPerformance, file = "./Objs/SVM/GSE32646_Out_SVM_AgnosticPerformance.rda")
