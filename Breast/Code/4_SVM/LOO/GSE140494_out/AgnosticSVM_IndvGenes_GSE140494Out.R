...
GSE140494_Out_SVM_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE140494_Out_SVM_IndvGenes_AgnosticPerformance, file = "./Objs/SVM/GSE140494_Out_SVM_IndvGenes_AgnosticPerformance.rda")
