...
Grid <- expand.grid(degree = 2, scale = 0.001, C = 2)
set.seed(333)
...
GSE140494_Out_SVM_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE140494_Out_SVM_AgnosticPerformance, file = "./Objs/SVM/GSE140494_Out_SVM_AgnosticPerformance.rda")
