...
## Load data
load("./Objs/KTSP/KTSP_STATs_Mechanistic_GSE140494Out.rda")
load("./Objs/ChemoDataNew_GSE140494Out.rda")
...
GSE140494_Out_SVM_MechPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE140494_Out_SVM_MechPerformance, file = "./Objs/SVM/GSE140494_Out_SVM_MechPerformance.rda")
