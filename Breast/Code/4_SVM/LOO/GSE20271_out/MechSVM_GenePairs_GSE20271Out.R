...
## Load data
load("./Objs/KTSP/KTSP_STATs_Mechanistic_GSE20271Out.rda")
...
Grid <- expand.grid(degree = 2, scale = 0.1, C = 4)
set.seed(333)
...
GSE20271_Out_SVM_MechPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE20271_Out_SVM_MechPerformance, file = "./Objs/SVM/GSE20271_Out_SVM_MechPerformance.rda")
