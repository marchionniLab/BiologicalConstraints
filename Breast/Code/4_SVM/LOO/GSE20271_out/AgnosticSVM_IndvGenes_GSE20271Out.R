...
GSE20271_Out_SVM_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE20271_Out_SVM_IndvGenes_AgnosticPerformance, file = "./Objs/SVM/GSE20271_Out_SVM_IndvGenes_AgnosticPerformance.rda")
