...
GSE103668_Out_SVM_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE103668_Out_SVM_IndvGenes_AgnosticPerformance, file = "./Objs/SVM/GSE103668_Out_SVM_IndvGenes_AgnosticPerformance.rda")
