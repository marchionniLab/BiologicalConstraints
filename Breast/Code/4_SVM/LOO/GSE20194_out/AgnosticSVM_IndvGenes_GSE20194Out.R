...
GSE20194_Out_SVM_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE20194_Out_SVM_IndvGenes_AgnosticPerformance, file = "./Objs/SVM/GSE20194_Out_SVM_IndvGenes_AgnosticPerformance.rda")
