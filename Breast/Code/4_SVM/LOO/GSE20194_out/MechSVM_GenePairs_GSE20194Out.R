...
## Load data
load("./Objs/KTSP/KTSP_STATs_Mechanistic_GSE20194Out.rda")
load("./Objs/ChemoDataNew_GSE20194Out.rda")
...
GSE20194_Out_SVM_MechPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE20194_Out_SVM_MechPerformance, file = "./Objs/SVM/GSE20194_Out_SVM_MechPerformance.rda")
