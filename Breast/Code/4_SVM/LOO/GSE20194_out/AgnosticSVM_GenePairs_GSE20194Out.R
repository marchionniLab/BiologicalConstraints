...
GSE20194_Out_SVM_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE20194_Out_SVM_AgnosticPerformance, file = "./Objs/SVM/GSE20194_Out_SVM_AgnosticPerformance.rda")
