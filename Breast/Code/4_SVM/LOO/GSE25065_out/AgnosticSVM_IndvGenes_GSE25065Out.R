...
GSE25065_Out_SVM_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE25065_Out_SVM_IndvGenes_AgnosticPerformance, file = "./Objs/SVM/GSE25065_Out_SVM_IndvGenes_AgnosticPerformance.rda")
