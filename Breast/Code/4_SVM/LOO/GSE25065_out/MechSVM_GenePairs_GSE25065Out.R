...
## Load data
load("./Objs/KTSP/KTSP_STATs_Mechanistic_GSE25065Out.rda")
load("./Objs/ChemoDataNew_GSE25065Out.rda")
...
GSE25065_Out_SVM_MechPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE25065_Out_SVM_MechPerformance, file = "./Objs/SVM/GSE25065_Out_SVM_MechPerformance.rda")
