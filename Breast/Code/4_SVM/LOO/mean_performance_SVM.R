...
AgnosticGSE25055_Out_pairs <- load("./Objs/SVM/GSE25055_Out_SVM_AgnosticPerformance.rda")
AgnosticGSE25065_Out_pairs <- load("./Objs/SVM/GSE25065_Out_SVM_AgnosticPerformance.rda")
AgnosticGSE140494_Out_pairs <- load("./Objs/SVM/GSE140494_Out_SVM_AgnosticPerformance.rda")
AgnosticGSE103668_Out_pairs <- load("./Objs/SVM/GSE103668_Out_SVM_AgnosticPerformance.rda")
AgnosticGSE20194_Out_pairs <- load("./Objs/SVM/GSE20194_Out_SVM_AgnosticPerformance.rda")
AgnosticGSE20271_Out_pairs <- load("./Objs/SVM/GSE20271_Out_SVM_AgnosticPerformance.rda")
AgnosticGSE32646_Out_pairs <- load("./Objs/SVM/GSE32646_Out_SVM_AgnosticPerformance.rda")

# Load the agnostic genes models
AgnosticGSE25055_Out_indvGenes <- load("./Objs/SVM/GSE25055_Out_SVM_indvGenes_AgnosticPerformance.rda")
AgnosticGSE25065_Out_indvGenes <- load("./Objs/SVM/GSE25065_Out_SVM_indvGenes_AgnosticPerformance.rda")
AgnosticGSE140494_Out_indvGenes <- load("./Objs/SVM/GSE140494_Out_SVM_indvGenes_AgnosticPerformance.rda")
AgnosticGSE103668_Out_indvGenes <- load("./Objs/SVM/GSE103668_Out_SVM_indvGenes_AgnosticPerformance.rda")
AgnosticGSE20194_Out_indvGenes <- load("./Objs/SVM/GSE20194_Out_SVM_indvGenes_AgnosticPerformance.rda")
AgnosticGSE20271_Out_indvGenes <- load("./Objs/SVM/GSE20271_Out_SVM_indvGenes_AgnosticPerformance.rda")
AgnosticGSE32646_Out_indvGenes <- load("./Objs/SVM/GSE32646_Out_SVM_indvGenes_AgnosticPerformance.rda")
...
GSE25055_Out_SVM_IndvGenes_AgnosticPerformance$out_study <- rep("GSE25055", nrow(GSE25055_Out_SVM_IndvGenes_AgnosticPerformance))
GSE25055_Out_SVM_MechPerformance$out_study <- rep("GSE25055", nrow(GSE25055_Out_SVM_MechPerformance))

GSE25055_Out_SVM_AgnosticPerformance$model_type <- rep("Agnostic_pairs", nrow(GSE25055_Out_SVM_AgnosticPerformance))
GSE25055_Out_SVM_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_genes", nrow(GSE25055_Out_SVM_IndvGenes_AgnosticPerformance))
...
GSE25065_Out_SVM_IndvGenes_AgnosticPerformance$out_study <- rep("GSE25065", nrow(GSE25065_Out_SVM_IndvGenes_AgnosticPerformance))
GSE25065_Out_SVM_MechPerformance$out_study <- rep("GSE25065", nrow(GSE25065_Out_SVM_MechPerformance))

GSE25065_Out_SVM_AgnosticPerformance$model_type <- rep("Agnostic_pairs", nrow(GSE25065_Out_SVM_AgnosticPerformance))
GSE25065_Out_SVM_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_genes", nrow(GSE25065_Out_SVM_IndvGenes_AgnosticPerformance))
...
GSE140494_Out_SVM_IndvGenes_AgnosticPerformance$out_study <- rep("GSE140494", nrow(GSE140494_Out_SVM_IndvGenes_AgnosticPerformance))
GSE140494_Out_SVM_MechPerformance$out_study <- rep("GSE140494", nrow(GSE140494_Out_SVM_MechPerformance))

GSE140494_Out_SVM_AgnosticPerformance$model_type <- rep("Agnostic_pairs", nrow(GSE140494_Out_SVM_AgnosticPerformance))
GSE140494_Out_SVM_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_genes", nrow(GSE140494_Out_SVM_IndvGenes_AgnosticPerformance))
...
GSE103668_Out_SVM_IndvGenes_AgnosticPerformance$out_study <- rep("GSE103668", nrow(GSE103668_Out_SVM_IndvGenes_AgnosticPerformance))
GSE103668_Out_SVM_MechPerformance$out_study <- rep("GSE103668", nrow(GSE103668_Out_SVM_MechPerformance))

GSE103668_Out_SVM_AgnosticPerformance$model_type <- rep("Agnostic_pairs", nrow(GSE103668_Out_SVM_AgnosticPerformance))
GSE103668_Out_SVM_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_genes", nrow(GSE103668_Out_SVM_IndvGenes_AgnosticPerformance))
...
GSE20194_Out_SVM_IndvGenes_AgnosticPerformance$out_study <- rep("GSE20194", nrow(GSE20194_Out_SVM_IndvGenes_AgnosticPerformance))
GSE20194_Out_SVM_MechPerformance$out_study <- rep("GSE20194", nrow(GSE20194_Out_SVM_MechPerformance))

GSE20194_Out_SVM_AgnosticPerformance$model_type <- rep("Agnostic_pairs", nrow(GSE20194_Out_SVM_AgnosticPerformance))
GSE20194_Out_SVM_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_genes", nrow(GSE20194_Out_SVM_IndvGenes_AgnosticPerformance))
...
GSE20271_Out_SVM_IndvGenes_AgnosticPerformance$out_study <- rep("GSE20271", nrow(GSE20271_Out_SVM_IndvGenes_AgnosticPerformance))
GSE20271_Out_SVM_MechPerformance$out_study <- rep("GSE20271", nrow(GSE20271_Out_SVM_MechPerformance))

GSE20271_Out_SVM_AgnosticPerformance$model_type <- rep("Agnostic_pairs", nrow(GSE20271_Out_SVM_AgnosticPerformance))
GSE20271_Out_SVM_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_genes", nrow(GSE20271_Out_SVM_IndvGenes_AgnosticPerformance))
...
GSE32646_Out_SVM_IndvGenes_AgnosticPerformance$out_study <- rep("GSE32646", nrow(GSE32646_Out_SVM_IndvGenes_AgnosticPerformance))
GSE32646_Out_SVM_MechPerformance$out_study <- rep("GSE32646", nrow(GSE32646_Out_SVM_MechPerformance))

GSE32646_Out_SVM_AgnosticPerformance$model_type <- rep("Agnostic_pairs", nrow(GSE32646_Out_SVM_AgnosticPerformance))
GSE32646_Out_SVM_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_genes", nrow(GSE32646_Out_SVM_IndvGenes_AgnosticPerformance))
GSE32646_Out_SVM_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE32646_Out_SVM_MechPerformance))


###############
All_SVM_CV <- rbind(GSE25055_Out_SVM_AgnosticPerformance, GSE25055_Out_SVM_IndvGenes_AgnosticPerformance, GSE25055_Out_SVM_MechPerformance,
                   GSE25065_Out_SVM_AgnosticPerformance, GSE25065_Out_SVM_IndvGenes_AgnosticPerformance, GSE25065_Out_SVM_MechPerformance,
                   GSE140494_Out_SVM_AgnosticPerformance, GSE140494_Out_SVM_IndvGenes_AgnosticPerformance, GSE140494_Out_SVM_MechPerformance, 
                   GSE103668_Out_SVM_AgnosticPerformance, GSE103668_Out_SVM_IndvGenes_AgnosticPerformance, GSE103668_Out_SVM_MechPerformance, 
                   GSE20194_Out_SVM_AgnosticPerformance, GSE20194_Out_SVM_IndvGenes_AgnosticPerformance, GSE20194_Out_SVM_MechPerformance,
                   GSE20271_Out_SVM_AgnosticPerformance, GSE20271_Out_SVM_IndvGenes_AgnosticPerformance, GSE20271_Out_SVM_MechPerformance,
                   GSE32646_Out_SVM_AgnosticPerformance, GSE32646_Out_SVM_IndvGenes_AgnosticPerformance, GSE32646_Out_SVM_MechPerformance)
