...
## Agnostic
load("./Objs/KTSP/KTSP_STATs_Agnostic_GSE103668Out.rda")
...
set.seed(333)
RF_Agnostic_OnKTSP <- randomForest(x =predictor_data, y=usedTrainGroup, importance = TRUE, ntree = 500, mtry = 30 ,proximity=TRUE, na.action = na.omit, sampsize = sampsizes)
RF_Agnostic_OnKTSP
...
GSE103668_Out_RF_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE103668_Out_RF_AgnosticPerformance, file = "./Objs/RF/GSE103668_Out_RF_AgnosticPerformance.rda")
