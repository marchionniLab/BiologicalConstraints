...
GSE103668_Out_RF_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE103668_Out_RF_IndvGenes_AgnosticPerformance, file = "./Objs/RF/GSE103668_Out_RF_IndvGenes_AgnosticPerformance.rda")
