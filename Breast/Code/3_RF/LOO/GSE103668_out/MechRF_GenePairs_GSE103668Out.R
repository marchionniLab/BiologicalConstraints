...
set.seed(333)
RF_Mechanistic_OnKTSP <- randomForest(x =predictor_data, y=usedTrainGroup, importance = TRUE, ntree = 500, mtry = 60, proximity=TRUE, na.action = na.omit, sampsize = sampsizes)
...
GSE103668_Out_RF_MechPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE103668_Out_RF_MechPerformance, file = "./Objs/RF/GSE103668_Out_RF_MechPerformance.rda")
