...
set.seed(333)
RF_Agnostic <- randomForest(x =predictor_data, y=target, importance = TRUE, ntree = 1000, mtry = 460 ,proximity=TRUE, na.action = na.omit, sampsize = sampsizes)
print(RF_Agnostic)
...
GSE20271_Out_RF_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE20271_Out_RF_IndvGenes_AgnosticPerformance, file = "./Objs/RF/GSE20271_Out_RF_IndvGenes_AgnosticPerformance.rda")
