...
GSE20271_Out_RF_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE20271_Out_RF_AgnosticPerformance, file = "./Objs/RF/GSE20271_Out_RF_AgnosticPerformance.rda")
