...
## Agnostic
load("./Objs/KTSP/KTSP_STATs_Agnostic_GSE20194Out.rda")
...
set.seed(333)
RF_Agnostic_OnKTSP <- randomForest(x =predictor_data, y=usedTrainGroup, importance = TRUE, ntree = 500, mtry = 8 ,proximity=TRUE, na.action = na.omit, sampsize = sampsizes)
RF_Agnostic_OnKTSP
...
GSE20194_Out_RF_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE20194_Out_RF_AgnosticPerformance, file = "./Objs/RF/GSE20194_Out_RF_AgnosticPerformance.rda")
