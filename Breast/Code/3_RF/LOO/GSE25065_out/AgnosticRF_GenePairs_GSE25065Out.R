...
## Agnostic
load("./Objs/KTSP/KTSP_STATs_Agnostic_GSE25065Out.rda")
...
GSE25065_Out_RF_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE25065_Out_RF_AgnosticPerformance, file = "./Objs/RF/GSE25065_Out_RF_AgnosticPerformance.rda")
