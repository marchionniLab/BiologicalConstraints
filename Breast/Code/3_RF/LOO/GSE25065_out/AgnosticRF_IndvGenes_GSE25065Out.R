...
GSE25065_Out_RF_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE25065_Out_RF_IndvGenes_AgnosticPerformance, file = "./Objs/RF/GSE25065_Out_RF_IndvGenes_AgnosticPerformance.rda")
