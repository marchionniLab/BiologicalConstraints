...
## Agnostic
load("./Objs/KTSP/KTSP_STATs_Agnostic_GSE32646Out.rda")
...
GSE32646_Out_RF_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE32646_Out_RF_AgnosticPerformance, file = "./Objs/RF/GSE32646_Out_RF_AgnosticPerformance.rda")
