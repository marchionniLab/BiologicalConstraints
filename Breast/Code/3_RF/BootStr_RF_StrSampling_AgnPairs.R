...
save(bootobjectMech, bootobjectAgnostic_25, bootobjectAgnostic_50, bootobjectAgnostic_100, bootobjectAgnostic_119, bootobjectAgnostic_250, file = "./Objs/RF/RFBootObjects_NotchAndMyc_AgnPairs.rda")
...
#############################################################################
## Save for the main figure
ModelCompare_RF <- rbind(ModelCompareAUC_Train_119, ModelCompareAUC_Test_119)
ModelCompare_RF$algorithm <- "RF"
save(ModelCompare_RF, file = "./Objs/RF/ModelCompare_RF_AgnPairs.rda")
