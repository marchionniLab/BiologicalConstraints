...
predictor_data_Train_Agnostic <- t(KTSP_STATs_Train_Agnostic_37)
predictor_data_Test_Agnostic <- t(KTSP_STATs_Test_Agnostic_37)
...
set.seed(333)
bootobjectAgnostic_37 <- boot(data= DataAgnostic_Train, statistic= RF_Strap, R= 1000, parallel = "multicore", ncpus = 15) 
...
save(bootobjectMech, bootobjectAgnostic_37, bootobjectAgnostic_50, bootobjectAgnostic_100, bootobjectAgnostic_250, file = "./Objs/RF/RFBootObjects_AgnPairs.rda")

## load
load("./Objs/RF/RFBootObjects_AgnPairs.rda")

########################################################################################
## Work with Agnostic bootobject 37 vs mechanistic

AUCs_RF_Agnostic_37 <- bootobjectAgnostic_37$t
colnames(AUCs_RF_Agnostic_37) <- c("AUC_Train", "AUC_Test", "N_ImportanVariables")
...
DiffAgnostic_37 <- AUCs_RF_Agnostic_37[, "AUC_Train"] - AUCs_RF_Agnostic_37[, "AUC_Test"]
...
AgnosticAUC_Train_37 <- data.frame(AUC = AUCs_RF_Agnostic_37[, "AUC_Train"])
...
AgnosticAUC_Test_37 <- data.frame(AUC = AUCs_RF_Agnostic_37[, "AUC_Test"])
...
ModelCompare_RF <- rbind(ModelCompareAUC_Train_37, ModelCompareAUC_Test_37)
...
load("./Objs/RF/ModelCompareAUC_74.rda")
...
# 
# 
# AUC_Train_DistrHist_37 <- ggplot(ModelCompareAUC_Train_37, aes(AUC, fill = modelType)) + 
#   geom_density(alpha = 0.5) +
#   scale_x_continuous(limits = c(0.5, 1)) +
#   labs(title="AUC distribution of the agnostic and mechanistic RF models in the training data") + My_Theme
# 
# AUC_Test_DistrHist_37 <- ggplot(ModelCompareAUC_Test_37, aes(AUC, fill = modelType)) + 
#   geom_density(alpha = 0.5) +
#   scale_x_continuous(limits = c(0.5, 1)) +
...
# #   My_Theme
# 
# png("./Figs/RF/RF_BS_AUC_37_AgnPairs.png", width = 3000, height = 1500, res = 300)
# (AUC_Train_DistrHist_37 / AUC_Test_DistrHist_37) | (DiffHist_Agnostic_37 / DiffHist_Mech) + plot_layout(widths = c(1, 1)) #| BarPlotImportance
# dev.off()
...
#   labs(title="AUC distribution of the agnostic and mechanistic RF models in the testing data") + My_Theme
# 
# png("./Figs/RF/RF_BS_AUC_50_AgnPairs.png", width = 3000, height = 1500, res = 300)
...
#   labs(title="AUC distribution of the agnostic and mechanistic RF models in the testing data") + My_Theme
# 
# png("./Figs/RF/RF_BS_AUC_100_AgnPairs.png", width = 3000, height = 1500, res = 300)
...
ModelCompare_RF_DiffNoFeat <- rbind(ModelCompareAUC_Train_37_74,
...
#   labs(title="Histogram of the difference between the training and testing data using the agnostic model") + My_Theme
# 
# AUC_Train_DistrHist_250 <- ggplot(ModelCompareAUC_Train_250, aes(AUC, fill = modelType)) + 
#   geom_density(alpha = 0.5) +
#   scale_x_continuous(limits = c(0.5, 1)) +
#   labs(title="AUC distribution of the agnostic and mechanistic RF models in the training data") + My_Theme
# 
# AUC_Test_DistrHist_250 <- ggplot(ModelCompareAUC_Test_250, aes(AUC, fill = modelType)) + 
#   geom_density(alpha = 0.5) +
#   scale_x_continuous(limits = c(0.5, 1)) +
#   labs(title="AUC distribution of the agnostic and mechanistic RF models in the testing data") + My_Theme
# 
# png("./Figs/RF/RF_BS_AUC_250_AgnPairs.png", width = 3000, height = 1250, res = 300)
# (AUC_Train_DistrHist_250 / AUC_Test_DistrHist_250) | (DiffHist_Agnostic_250 / DiffHist_Mech) + plot_layout(widths = c(1, 1)) #| BarPlotImportance
# dev.off()
# 
# 
# ###########################################
...
#   geom_density(alpha = 0.5) +
#   scale_x_continuous(limits = c(0.5, 1)) +
#   labs(title="Agnostic (37 pairs) vs mechanistic RF models in the training data") + My_Theme2
# 
# AUC_Test_DistrHist_37 <- ggplot(ModelCompareAUC_Test_37, aes(AUC, fill = modelType)) + 
#   geom_density(alpha = 0.5) +
#   scale_x_continuous(limits = c(0.5, 1)) +
#   labs(title="Agnostic (37 pairs) vs mechanistic RF models in the testing data") + My_Theme2
# 
# #############################
# AUC_Train_DistrHist_50 <- ggplot(ModelCompareAUC_Train_50, aes(AUC, fill = modelType)) + 
#   geom_density(alpha = 0.5) +
#   scale_x_continuous(limits = c(0.5, 1)) +
#   labs(title="Agnostic (50 pairs) vs mechanistic RF models in the training data") + My_Theme2
# 
# AUC_Test_DistrHist_50 <- ggplot(ModelCompareAUC_Test_50, aes(AUC, fill = modelType)) + 
#   geom_density(alpha = 0.5) +
#   scale_x_continuous(limits = c(0.5, 1)) +
#   labs(title="Agnostic (50 pairs) vs mechanistic RF models in the testing data") + My_Theme2
# 
# ##############################
# AUC_Train_DistrHist_100 <- ggplot(ModelCompareAUC_Train_100, aes(AUC, fill = modelType)) + 
#   geom_density(alpha = 0.5) +
#   scale_x_continuous(limits = c(0.5, 1)) +
#   labs(title="Agnostic (100 pairs) vs mechanistic RF models in the training data") + My_Theme2
# 
# AUC_Test_DistrHist_100 <- ggplot(ModelCompareAUC_Test_100, aes(AUC, fill = modelType)) + 
#   geom_density(alpha = 0.5) +
#   scale_x_continuous(limits = c(0.5, 1)) +
#   labs(title="Agnostic (100 pairs) vs mechanistic RF models in the testing data") + My_Theme2
# 
# ###############################
# AUC_Train_DistrHist_250 <- ggplot(ModelCompareAUC_Train_250, aes(AUC, fill = modelType)) + 
#   geom_density(alpha = 0.5) +
#   scale_x_continuous(limits = c(0.5, 1)) +
#   labs(title="Agnostic (250 pairs) vs mechanistic RF models in the training data") + My_Theme2
# 
# AUC_Test_DistrHist_250 <- ggplot(ModelCompareAUC_Test_250, aes(AUC, fill = modelType)) + 
#   geom_density(alpha = 0.5) +
#   scale_x_continuous(limits = c(0.5, 1)) +
#   labs(title="Agnostic (250 pairs) vs mechanistic RF models in the testing data") + My_Theme2
# 
# 
# # All in one figure
# png("./Figs/BootStrap_Diff_No_features/GenePairs/RF_BS_AUC_DiffPairs.png", width = 3000, height = 1500, res = 150)
