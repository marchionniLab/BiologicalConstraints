...
set.seed(333)
bootobjectAgnostic_74 <- boot(data= DataAgnostic_Train, statistic= RF_Strap, R= 1000, parallel = "multicore", ncpus = 15) 
...
AgnosticAUC_Train_74$modelType <- "Agnostic_DEGs"
...
AgnosticAUC_Test_74$modelType <- "Agnostic_DEGs"
...
# #   My_Theme
# 
# png("./Figs/RF/RF_BS_AUC_74.png", width = 3000, height = 1500, res = 300)
...
#   geom_density(alpha = 0.5) +
#   scale_x_continuous(limits = c(0.5, 1)) +
#   labs(title="Agnostic (top 74 DEGs) vs mechanistic RF models in the training data") + My_Theme2
# 
# AUC_Test_DistrHist_74 <- ggplot(ModelCompareAUC_Test_74, aes(AUC, fill = modelType)) + 
#   geom_density(alpha = 0.5) +
#   scale_x_continuous(limits = c(0.5, 1)) +
#   labs(title="Agnostic (top 74 DEGs) vs mechanistic RF models in the testing data") + My_Theme2
# #############################
# AUC_Train_DistrHist_100 <- ggplot(ModelCompareAUC_Train_100, aes(AUC, fill = modelType)) + 
#   geom_density(alpha = 0.5) +
#   scale_x_continuous(limits = c(0.5, 1)) +
...
# 
# # All in one figure
# png("./Figs/BootStrap_Diff_No_features/RF_BS_AUC_DiffFeatures.png", width = 3000, height = 1500, res = 150)
