...
GSE13507_Out_RF_MechPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE13507_Out_RF_MechPerformance, file = "./Objs/RF/GSE13507_Out_RF_MechPerformance.rda")
...
###################
### Plot Curve
png("./Figs/RF/CompareAUCggplot_GSE13507Out.png",
    width=3000, height=3000, res=360)
### Color
myCol <- brewer.pal(3, "Dark2")[c(2,1)]
### Plot and legend titles
plotTitle <- "AUC mechanistic vs agnostic RF (GSE13507 for validation))"
legendTitle <- "Mechanistic VS Agnostic"
### Plot
basicplot_RF_GSE13507Out <- ggplot(dat_RF, aes(d=Progression, m=RF_sum, color=RF_type,
                                   linetype = RF_type)) +
...
### Plot
basicplot_RF_GSE13507Out
### Close device
dev.off()


save(basicplot_RF_GSE13507Out, file = "./Objs/RF/BasicPlot_RF_GSE13507Out.rda")
