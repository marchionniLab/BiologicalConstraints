...
EMTAB_Out_RF_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(EMTAB_Out_RF_IndvGenes_AgnosticPerformance, file = "./Objs/RF/EMTAB_Out_RF_IndvGenes_AgnosticPerformance.rda")
