...
# Load the agnostic models (Indv genes)
AgnosticEMTAB_Out_IndGenes <- load("./Objs/RF/EMTAB_Out_RF_IndvGenes_AgnosticPerformance.rda")
AgnosticGSE13507_Out_IndGenes <- load("./Objs/RF/GSE13507_Out_RF_IndvGenes_AgnosticPerformance.rda")
AgnosticGSE32894_Out_IndGenes <- load("./Objs/RF/GSE32894_Out_RF_IndvGenes_AgnosticPerformance.rda")
AgnosticGSE57813_Out_IndGenes <- load("./Objs/RF/GSE57813_Out_RF_IndvGenes_AgnosticPerformance.rda")
AgnosticPMID_Out_IndGenes <- load("./Objs/RF/PMID_Out_RF_IndvGenes_AgnosticPerformance.rda")

# Load the agnostic models (Pairs)
AgnosticEMTAB_Out_Pairs <- load("./Objs/RF/EMTAB_Out_RF_AgnosticPerformance.rda")
AgnosticGSE13507_Out_Pairs <- load("./Objs/RF/GSE13507_Out_RF_AgnosticPerformance.rda")
AgnosticGSE32894_Out_Pairs <- load("./Objs/RF/GSE32894_Out_RF_AgnosticPerformance.rda")
AgnosticGSE57813_Out_Pairs <- load("./Objs/RF/GSE57813_Out_RF_AgnosticPerformance.rda")
AgnosticPMID_Out_Pairs <- load("./Objs/RF/PMID_Out_RF_AgnosticPerformance.rda")


# Load the Mech models
MechEMTAB_Out <- load("./Objs/RF/EMTAB_Out_RF_MechPerformance.rda")
MechGSE13507_Out <- load("./Objs/RF/GSE13507_Out_RF_MechPerformance.rda")
MechGSE32894_Out <- load("./Objs/RF/GSE32894_Out_RF_MechPerformance.rda")
MechGSE57813_Out <- load("./Objs/RF/GSE57813_Out_RF_MechPerformance.rda")
MechPMID_Out <- load("./Objs/RF/PMID_Out_RF_MechPerformance.rda")
...
# EMTAB_out
EMTAB_Out_RF_IndvGenes_AgnosticPerformance$out_study <- rep("EMTAB", nrow(EMTAB_Out_RF_IndvGenes_AgnosticPerformance))
EMTAB_Out_RF_AgnosticPerformance$out_study <- rep("EMTAB", nrow(EMTAB_Out_RF_AgnosticPerformance))
EMTAB_Out_RF_MechPerformance$out_study <- rep("EMTAB", nrow(EMTAB_Out_RF_MechPerformance))

EMTAB_Out_RF_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_IndGenes", nrow(EMTAB_Out_RF_IndvGenes_AgnosticPerformance))
EMTAB_Out_RF_AgnosticPerformance$model_type <- rep("Agnostic_Pairs", nrow(EMTAB_Out_RF_AgnosticPerformance))
EMTAB_Out_RF_MechPerformance$model_type <- rep("Mechanistic", nrow(EMTAB_Out_RF_MechPerformance))

# GSE13507_out
GSE13507_Out_RF_IndvGenes_AgnosticPerformance$out_study <- rep("GSE13507", nrow(GSE13507_Out_RF_IndvGenes_AgnosticPerformance))
GSE13507_Out_RF_AgnosticPerformance$out_study <- rep("GSE13507", nrow(GSE13507_Out_RF_AgnosticPerformance))
GSE13507_Out_RF_MechPerformance$out_study <- rep("GSE13507", nrow(GSE13507_Out_RF_MechPerformance))

GSE13507_Out_RF_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_IndGenes", nrow(GSE13507_Out_RF_IndvGenes_AgnosticPerformance))
GSE13507_Out_RF_AgnosticPerformance$model_type <- rep("Agnostic_Pairs", nrow(GSE13507_Out_RF_AgnosticPerformance))
GSE13507_Out_RF_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE13507_Out_RF_MechPerformance))

# GSE32894_out
GSE32894_Out_RF_IndvGenes_AgnosticPerformance$out_study <- rep("GSE32894", nrow(GSE32894_Out_RF_IndvGenes_AgnosticPerformance))
GSE32894_Out_RF_AgnosticPerformance$out_study <- rep("GSE32894", nrow(GSE32894_Out_RF_AgnosticPerformance))
GSE32894_Out_RF_MechPerformance$out_study <- rep("GSE32894", nrow(GSE32894_Out_RF_MechPerformance))

GSE32894_Out_RF_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_IndGenes", nrow(GSE32894_Out_RF_IndvGenes_AgnosticPerformance))
GSE32894_Out_RF_AgnosticPerformance$model_type <- rep("Agnostic_Pairs", nrow(GSE32894_Out_RF_AgnosticPerformance))
GSE32894_Out_RF_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE32894_Out_RF_MechPerformance))

# GSE57813_out
GSE57813_Out_RF_IndvGenes_AgnosticPerformance$out_study <- rep("GSE57813", nrow(GSE57813_Out_RF_IndvGenes_AgnosticPerformance))
GSE57813_Out_RF_AgnosticPerformance$out_study <- rep("GSE57813", nrow(GSE57813_Out_RF_AgnosticPerformance))
GSE57813_Out_RF_MechPerformance$out_study <- rep("GSE57813", nrow(GSE57813_Out_RF_MechPerformance))

GSE57813_Out_RF_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_IndGenes", nrow(GSE57813_Out_RF_IndvGenes_AgnosticPerformance))
GSE57813_Out_RF_AgnosticPerformance$model_type <- rep("Agnostic_Pairs", nrow(GSE57813_Out_RF_AgnosticPerformance))
GSE57813_Out_RF_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE57813_Out_RF_MechPerformance))

# PMID_out
PMID_Out_RF_IndvGenes_AgnosticPerformance$out_study <- rep("PMID", nrow(PMID_Out_RF_IndvGenes_AgnosticPerformance))
PMID_Out_RF_AgnosticPerformance$out_study <- rep("PMID", nrow(PMID_Out_RF_AgnosticPerformance))
PMID_Out_RF_MechPerformance$out_study <- rep("PMID", nrow(PMID_Out_RF_MechPerformance))

PMID_Out_RF_IndvGenes_AgnosticPerformance$model_type <- rep("Agnostic_IndGenes", nrow(PMID_Out_RF_IndvGenes_AgnosticPerformance))
PMID_Out_RF_AgnosticPerformance$model_type <- rep("Agnostic_Pairs", nrow(PMID_Out_RF_AgnosticPerformance))
PMID_Out_RF_MechPerformance$model_type <- rep("Mechanistic", nrow(PMID_Out_RF_MechPerformance))


All_RF_CV <- rbind(EMTAB_Out_RF_IndvGenes_AgnosticPerformance, EMTAB_Out_RF_AgnosticPerformance, EMTAB_Out_RF_MechPerformance,
                   GSE13507_Out_RF_IndvGenes_AgnosticPerformance, GSE13507_Out_RF_AgnosticPerformance, GSE13507_Out_RF_MechPerformance,
                   GSE32894_Out_RF_IndvGenes_AgnosticPerformance, GSE32894_Out_RF_AgnosticPerformance, GSE32894_Out_RF_MechPerformance, 
                   GSE57813_Out_RF_IndvGenes_AgnosticPerformance, GSE57813_Out_RF_AgnosticPerformance, GSE57813_Out_RF_MechPerformance, 
                   PMID_Out_RF_IndvGenes_AgnosticPerformance, PMID_Out_RF_AgnosticPerformance, PMID_Out_RF_MechPerformance)
...
MeanAUC_Agnostic_IndGenes <-  apply(All_RF_CV %>%
...
SD_AUC_Agnostic_IndGenes <-  apply(All_RF_CV %>%
                            filter(model_type == "Agnostic_IndGenes") %>%
                            filter(metric == "AUC") %>%
...
MeanAccuracy_Agnostic_IndGenes <-  apply(All_RF_CV %>%
                                  filter(model_type == "Agnostic_IndGenes") %>%
                                  filter(metric == "Accuracy") %>%
                                  select(c("Training", "Testing")), 2, mean)

# Accuracy SD in both the training and testing data
SD_Accuracy_Agnostic_IndGenes <-  apply(All_RF_CV %>%
                                 filter(model_type == "Agnostic_IndGenes") %>%
                                 filter(metric == "Accuracy") %>%
                                 select(c("Training", "Testing")), 2, sd)
...
MeanBalAccuracy_Agnostic_IndGenes <-  apply(All_RF_CV %>%
                                     filter(model_type == "Agnostic_IndGenes") %>%
                                     filter(metric == "Bal.Accuracy") %>%
                                     select(c("Training", "Testing")), 2, mean)

# Balanced Accuracy SD in both the training and testing data
SD_BalAccuracy_Agnostic_IndGenes <-  apply(All_RF_CV %>%
                                    filter(model_type == "Agnostic_IndGenes") %>%
                                    filter(metric == "Bal.Accuracy") %>%
                                    select(c("Training", "Testing")), 2, sd)
...
MeanSensitivity_Agnostic_IndGenes <-  apply(All_RF_CV %>%
                                     filter(model_type == "Agnostic_IndGenes") %>%
                                     filter(metric == "Sensitivity") %>%
                                     select(c("Training", "Testing")), 2, mean)

# Sensitivity SD in both the training and testing data
SD_Sensitivity_Agnostic_IndGenes <-  apply(All_RF_CV %>%
                                    filter(model_type == "Agnostic_IndGenes") %>%
                                    filter(metric == "Sensitivity") %>%
                                    select(c("Training", "Testing")), 2, sd)
...
MeanSpecificity_Agnostic_IndGenes <-  apply(All_RF_CV %>%
                                     filter(model_type == "Agnostic_IndGenes") %>%
                                     filter(metric == "Specificity") %>%
                                     select(c("Training", "Testing")), 2, mean)

# Specificity SD in both the training and testing data
SD_Specificity_Agnostic_IndGenes <-  apply(All_RF_CV %>%
                                    filter(model_type == "Agnostic_IndGenes") %>%
                                    filter(metric == "Specificity") %>%
                                    select(c("Training", "Testing")), 2, sd)
...
MeanMCC_Agnostic_IndGenes <-  apply(All_RF_CV %>%
                             filter(model_type == "Agnostic_IndGenes") %>%
                             filter(metric == "MCC") %>%
                             select(c("Training", "Testing")), 2, mean)

# MCC SD in both the training and testing data
SD_MCC_Agnostic_IndGenes <-  apply(All_RF_CV %>%
                            filter(model_type == "Agnostic_IndGenes") %>%
                            filter(metric == "MCC") %>%
                            select(c("Training", "Testing")), 2, sd)
...
RF_CrossStudyValidation <- cbind(MeansAgnostic_IndGenes, MeansAgnostic_Pairs, MeansMechanistic)
save(RF_CrossStudyValidation, file = "./Objs/RF/RF_CrossStudyValidation.rda")
...
# 
# # CIs for Accuracy
# Accuracy_Train_Agnostic <- All_RF_CV %>%
...
# Bal.Accuracy_Train_Agnostic <- All_RF_CV %>%
...
# 
# # CIs for sensitivity
# Sensitivity_Train_Agnostic <- All_RF_CV %>%
...
# 
# # CIs for Specificity
# Specificity_Train_Agnostic <- All_RF_CV %>%
...
# 
# # CIs for Accuracy
# Accuracy_Test_Agnostic <- All_RF_CV %>%
#   filter(metric == "Accuracy", model_type == "Agnostic") %>%
#   select(Testing)
# 
...
# 
# # CIs for Bal. Accuracy
# Bal.Accuracy_Test_Agnostic <- All_RF_CV %>%
#   filter(metric == "Bal.Accuracy", model_type == "Agnostic") %>%
#   select(Testing)
# 
# 
...
# 
# # CIs for sensitivity
# Sensitivity_Test_Agnostic <- All_RF_CV %>%
#   filter(metric == "Sensitivity", model_type == "Agnostic") %>%
#   select(Testing)
# 
...
# 
# # CIs for Specificity
# Specificity_Test_Agnostic <- All_RF_CV %>%
#   filter(metric == "Specificity", model_type == "Agnostic") %>%
#   select(Testing)
# 
...
# 
# ## CIs for AUC
# AUCs_Train_Mechanistic <- All_RF_CV %>%
...
# 
# # CIs for Accuracy
# Accuracy_Train_Mechanistic <- All_RF_CV %>%
...
# 
# # CIs for Bal. Accuracy
# Bal.Accuracy_Train_Mechanistic <- All_RF_CV %>%
...
# 
# # CIs for sensitivity
# Sensitivity_Train_Mechanistic <- All_RF_CV %>%
...
# 
# # CIs for Specificity
# Specificity_Train_Mechanistic <- All_RF_CV %>%
...
# 
# # CIs for MCC
# MCC_Train_Mechanistic <- All_RF_CV %>%
...
# 
# ## CIs for AUC
# AUCs_Test_Mechanistic <- All_RF_CV %>%
#   filter(metric == "AUC", model_type == "Mechanistic") %>%
#   select(Testing)
# 
...
# 
# # CIs for Accuracy
# Accuracy_Test_Mechanistic <- All_RF_CV %>%
#   filter(metric == "Accuracy", model_type == "Mechanistic") %>%
#   select(Testing)
# 
...
# 
# # CIs for Bal. Accuracy
# Bal.Accuracy_Test_Mechanistic <- All_RF_CV %>%
#   filter(metric == "Bal.Accuracy", model_type == "Mechanistic") %>%
#   select(Testing)
# 
# 
...
# 
# # CIs for sensitivity
# Sensitivity_Test_Mechanistic <- All_RF_CV %>%
#   filter(metric == "Sensitivity", model_type == "Mechanistic") %>%
#   select(Testing)
# 
...
# 
# # CIs for Specificity
# Specificity_Test_Mechanistic <- All_RF_CV %>%
#   filter(metric == "Specificity", model_type == "Mechanistic") %>%
#   select(Testing)
# 
...
# 
# # CIs for MCC
# MCC_Test_Mechanistic <- All_RF_CV %>%
#   filter(metric == "MCC", model_type == "Mechanistic") %>%
#   select(Testing)
# 
...
# 
# ## Save the Dataframe 
# save(RF_CV_AllMetrics, file = "./Objs/RF/RF_CV_AllMetrics.rda")
# 
