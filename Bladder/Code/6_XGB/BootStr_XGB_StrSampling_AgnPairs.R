...
################################################################################
### Save boot objects
save(bootobjectMech, bootobjectAgnostic_37, bootobjectAgnostic_50, bootobjectAgnostic_100, bootobjectAgnostic_250, file = "./Objs/XGB/XGBBootObjects_AgnPairs.rda")
...
load("./Objs/XGB/ModelCompareAUC_74.rda")
...
# 
# AUC_Train_DistrHist_37_74 <- ggplot(ModelCompareAUC_Train_37_74, aes(AUC, fill = modelType)) + 
#   geom_density(alpha = 0.5) +
#   scale_x_continuous(limits = c(0.5, 1)) +
#   labs(title="AUC distribution of the agnostic and mechanistic XGB models in the training data") + My_Theme
# 
# AUC_Test_DistrHist_37_74 <- ggplot(ModelCompareAUC_Test_37_74, aes(AUC, fill = modelType)) + 
#   geom_density(alpha = 0.5) +
#   scale_x_continuous(limits = c(0.5, 1)) +
...
# 
# 
# #png("./Figs/XGB/XGB_BS_AUC_37_AgnPairs.png", width = 3000, height = 1500, res = 300)
# (AUC_Train_DistrHist_37 / AUC_Test_DistrHist_37) + plot_layout(widths = c(2, 1)) 
# #dev.off()
...
# #   labs(title="Histogram of the difference between the training and testing data using the mechanistic model") + My_Theme
# 
# AUC_Train_DistrHist_50_100 <- ggplot(ModelCompareAUC_Train_50_100, aes(AUC, fill = modelType)) + 
#   geom_density(alpha = 0.5) +
#   scale_x_continuous(limits = c(0.5, 1)) +
#   labs(title="AUC distribution of the agnostic and mechanistic XGB models in the training data") + My_Theme
# 
# AUC_Test_DistrHist_50_100 <- ggplot(ModelCompareAUC_Test_50_100, aes(AUC, fill = modelType)) + 
#   geom_density(alpha = 0.5) +
#   scale_x_continuous(limits = c(0.5, 1)) +
#   labs(title="AUC distribution of the agnostic and mechanistic XGB models in the testing data") + My_Theme
# 
...
# 
# 
# #png("./Figs/XGB/XGB_BS_AUC_50_AgnPairs.png", width = 3000, height = 1500, res = 300)
# (AUC_Train_DistrHist_50_100 / AUC_Test_DistrHist_50_100) + plot_layout(widths = c(2, 1)) #| BarPlotImportance
# #dev.off()
...
# #   labs(title="Histogram of the difference between the training and testing data using the mechanistic model") + My_Theme
# 
# AUC_Train_DistrHist_250_500 <- ggplot(ModelCompareAUC_Train_250_500, aes(AUC, fill = modelType)) + 
#   geom_density(alpha = 0.5) +
#   scale_x_continuous(limits = c(0.5, 1)) +
#   labs(title="AUC distribution of the agnostic and mechanistic XGB models in the training data") + My_Theme
# 
# AUC_Test_DistrHist_250_500 <- ggplot(ModelCompareAUC_Test_250_500, aes(AUC, fill = modelType)) + 
#   geom_density(alpha = 0.5) +
#   scale_x_continuous(limits = c(0.5, 1)) +
#   labs(title="AUC distribution of the agnostic and mechanistic XGB models in the testing data") + My_Theme
# 
# #png("./Figs/XGB/XGB_BS_AUC_250_AgnPairs.png", width = 3000, height = 1500, res = 300)
# (AUC_Train_DistrHist_250_500 / AUC_Test_DistrHist_250_500) + plot_layout(widths = c(2, 1)) #| BarPlotImportance
# #dev.off()
# 
# ################################################################################################
# ################################################################################################
...
#   geom_density(alpha = 0.5) +
#   scale_x_continuous(limits = c(0.5, 1)) +
#   labs(title="Agnostic (37 pairs / 74 features) vs mechanistic in the training") + My_Theme2
# 
# AUC_Test_DistrHist_37_74 <- ggplot(ModelCompareAUC_Test_37_74, aes(AUC, fill = modelType)) + 
#   geom_density(alpha = 0.5) +
#   scale_x_continuous(limits = c(0.5, 1)) +
#   labs(title="Agnostic (37 pairs / 74 features) vs mechanistic in the testing") + My_Theme2
# #############################
# AUC_Train_DistrHist_50_100 <- ggplot(ModelCompareAUC_Train_50_100, aes(AUC, fill = modelType)) + 
#   geom_density(alpha = 0.5) +
#   scale_x_continuous(limits = c(0.5, 1)) +
#   labs(title="Agnostic (50 pairs / 100 features) vs mechanistic in the training") + My_Theme2
# 
# AUC_Test_DistrHist_50_100 <- ggplot(ModelCompareAUC_Test_50_100, aes(AUC, fill = modelType)) + 
#   geom_density(alpha = 0.5) +
#   scale_x_continuous(limits = c(0.5, 1)) +
#   labs(title="Agnostic (50 pairs / 100 features) vs mechanistic in the testing") + My_Theme2
# ##############################
# AUC_Train_DistrHist_100_200 <- ggplot(ModelCompareAUC_Train_100_200, aes(AUC, fill = modelType)) + 
#   geom_density(alpha = 0.5) +
#   scale_x_continuous(limits = c(0.5, 1)) +
#   labs(title="Agnostic (100 pairs / 200 features) vs mechanistic in the training") + My_Theme2
# 
# AUC_Test_DistrHist_100_200 <- ggplot(ModelCompareAUC_Test_100_200, aes(AUC, fill = modelType)) + 
#   geom_density(alpha = 0.5) +
#   scale_x_continuous(limits = c(0.5, 1)) +
#   labs(title="Agnostic (100 pairs / 200 features) vs mechanistic in the testing") + My_Theme2
# 
# ###############################
# AUC_Train_DistrHist_250_500 <- ggplot(ModelCompareAUC_Train_250_500, aes(AUC, fill = modelType)) + 
#   geom_density(alpha = 0.5) +
#   scale_x_continuous(limits = c(0.5, 1)) +
#   labs(title="Agnostic (250 pairs / 500 features) vs mechanistic in the training") + My_Theme2
# 
# AUC_Test_DistrHist_250_500 <- ggplot(ModelCompareAUC_Test_250_500, aes(AUC, fill = modelType)) + 
#   geom_density(alpha = 0.5) +
#   scale_x_continuous(limits = c(0.5, 1)) +
#   labs(title="Agnostic (250 pairs / 500 features) vs mechanistic in the testing") + My_Theme2
# 
# 
# # All in one figure
# png("./Figs/BootStrap_Diff_No_features/XGB_BS_AUC_Diff.png", width = 3000, height = 1500, res = 150)
# (AUC_Train_DistrHist_37_74 / AUC_Test_DistrHist_37_74) | (AUC_Train_DistrHist_50_100 / AUC_Test_DistrHist_50_100) | (AUC_Train_DistrHist_100_200 / AUC_Test_DistrHist_100_200) | (AUC_Train_DistrHist_250_500 / AUC_Test_DistrHist_250_500) + plot_layout(widths = c(1, 1)) 
# dev.off()
# 
