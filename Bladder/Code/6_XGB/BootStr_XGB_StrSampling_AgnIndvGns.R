...
### Save boot objects
save(bootobjectMech, bootobjectAgnostic_74, bootobjectAgnostic_100, bootobjectAgnostic_200, bootobjectAgnostic_500, file = "./Objs/XGB/XGBBootObjects.rda")
...
save(ModelCompareAUC_Train_74, ModelCompareAUC_Test_74, file = "./Objs/XGB/ModelCompareAUC_74.rda")
...
#png("./Figs/XGB/XGB_BS_AUC_74.png", width = 3000, height = 1500, res = 300)
...
AUC_Train_DistrHist_74 <- ggplot(ModelCompareAUC_Train_74, aes(AUC, fill = modelType)) + 
  geom_density(alpha = 0.5) +
  scale_x_continuous(limits = c(0.5, 1)) +
  labs(title="Agnostic (top 74 DEGs) vs mechanistic XGB models in the training data") + My_Theme2

AUC_Test_DistrHist_74 <- ggplot(ModelCompareAUC_Test_74, aes(AUC, fill = modelType)) + 
  geom_density(alpha = 0.5) +
  scale_x_continuous(limits = c(0.5, 1)) +
  labs(title="Agnostic (top 74 DEGs) vs mechanistic XGB models in the testing data") + My_Theme2
#############################
AUC_Train_DistrHist_100 <- ggplot(ModelCompareAUC_Train_100, aes(AUC, fill = modelType)) + 
  geom_density(alpha = 0.5) +
  scale_x_continuous(limits = c(0.5, 1)) +
...
# All in one figure
png("./Figs/BootStrap_Diff_No_features/XGB_BS_AUC_DiffFeatures.png", width = 3000, height = 1500, res = 150)
