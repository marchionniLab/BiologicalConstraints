## Agnostic XGB
## Gene pairs
## Cross-study valiation (GSE32894 out)
...
GSE32894_Out_XGB_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE32894_Out_XGB_IndvGenes_AgnosticPerformance, file = "./Objs/XGB/GSE32894_Out_XGB_IndvGenes_AgnosticPerformance.rda")
