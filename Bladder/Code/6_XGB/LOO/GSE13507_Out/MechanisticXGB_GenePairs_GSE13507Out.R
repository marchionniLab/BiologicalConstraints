...
## Load data
load("./Objs/KTSP/KTSP_STATs_Mechanistic_GSE13507Out.rda")
...
GSE13507_Out_XGB_MechPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE13507_Out_XGB_MechPerformance, file = "./Objs/XGB/GSE13507_Out_XGB_MechPerformance.rda")
...
###################
### Plot Curve
png("./Figs/XGB/CompareAUCggplot_GSE13507Out.png",
...
### Plot
basicplot_XGB_GSE13507Out <- ggplot(dat_XGB, aes(d=Progression, m=XGB_sum, color=XGB_type,
                                     linetype = XGB_type)) +
...
### Plot
basicplot_XGB_GSE13507Out
### Close device
dev.off()

save(basicplot_XGB_GSE13507Out, file = "./Objs/XGB/BasicPlot_XGB_GSE13507Out.rda")
