## Agnostic XGB
## Gene pairs
## Cross-study valiation (GSE13507 out)
...
parameters <- list(
  ...
  colsample_bytree   = 1,           #0.5     # default = 1,   range: (0,1]
...
GSE13507_Out_XGB_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE13507_Out_XGB_IndvGenes_AgnosticPerformance, file = "./Objs/XGB/GSE13507_Out_XGB_IndvGenes_AgnosticPerformance.rda")
