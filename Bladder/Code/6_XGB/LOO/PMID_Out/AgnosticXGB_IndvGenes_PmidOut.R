## Agnostic XGB
## Gene pairs
## Cross-study valiation (PMID out)
...
PMID_Out_XGB_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(PMID_Out_XGB_IndvGenes_AgnosticPerformance, file = "./Objs/XGB/PMID_Out_XGB_IndvGenes_AgnosticPerformance.rda")
