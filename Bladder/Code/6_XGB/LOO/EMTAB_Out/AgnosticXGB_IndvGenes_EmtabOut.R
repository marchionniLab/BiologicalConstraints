## Agnostic XGB
## Gene pairs
## Cross-study valiation (EMTAB out)
...
EMTAB_Out_XGB_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(EMTAB_Out_XGB_IndvGenes_AgnosticPerformance, file = "./Objs/XGB/EMTAB_Out_XGB_IndvGenes_AgnosticPerformance.rda")
