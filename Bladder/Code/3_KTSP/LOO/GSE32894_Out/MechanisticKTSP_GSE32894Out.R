...
GSE32894_Out_MechPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE32894_Out_MechPerformance, file = "./Objs/KTSP/GSE32894_Out_MechPerformance.rda")
...
### Plot
basicplot_KTSP_GSE32894Out
### Close device
dev.off()

save(basicplot_KTSP_GSE32894Out, file = "./Objs/KTSP/BasicPlot_KTSP_GSE32894out.rda")
