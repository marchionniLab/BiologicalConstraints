...
AgnosticEMTAB_Out <- load("./Objs/KTSP/EMTAB_Out_AgnosticPerformance.rda")
AgnosticGSE13507_Out <- load("./Objs/KTSP/GSE13507_Out_AgnosticPerformance.rda")
AgnosticGSE32894_Out <- load("./Objs/KTSP/GSE32894_Out_AgnosticPerformance.rda")
AgnosticGSE57813_Out <- load("./Objs/KTSP/GSE57813_Out_AgnosticPerformance.rda")
AgnosticPMID_Out <- load("./Objs/KTSP/PMID_Out_AgnosticPerformance.rda")

# Load the Mech models
MechEMTAB_Out <- load("./Objs/KTSP/EMTAB_Out_MechPerformance.rda")
MechGSE13507_Out <- load("./Objs/KTSP/GSE13507_Out_MechPerformance.rda")
MechGSE32894_Out <- load("./Objs/KTSP/GSE32894_Out_MechPerformance.rda")
MechGSE57813_Out <- load("./Objs/KTSP/GSE57813_Out_MechPerformance.rda")
MechPMID_Out <- load("./Objs/KTSP/PMID_Out_MechPerformance.rda")
...
# EMTAB_out
EMTAB_Out_AgnosticPerformance$out_study <- rep("EMTAB", nrow(EMTAB_Out_AgnosticPerformance))
EMTAB_Out_MechPerformance$out_study <- rep("EMTAB", nrow(EMTAB_Out_MechPerformance))
EMTAB_Out_AgnosticPerformance$model_type <- rep("Agnostic", nrow(EMTAB_Out_AgnosticPerformance))
EMTAB_Out_MechPerformance$model_type <- rep("Mechanistic", nrow(EMTAB_Out_MechPerformance))

# GSE13507_out
GSE13507_Out_AgnosticPerformance$out_study <- rep("GSE13507", nrow(GSE13507_Out_AgnosticPerformance))
GSE13507_Out_MechPerformance$out_study <- rep("GSE13507", nrow(GSE13507_Out_MechPerformance))
GSE13507_Out_AgnosticPerformance$model_type <- rep("Agnostic", nrow(GSE13507_Out_AgnosticPerformance))
GSE13507_Out_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE13507_Out_MechPerformance))

# GSE32894_out
GSE32894_Out_AgnosticPerformance$out_study <- rep("GSE32894", nrow(GSE32894_Out_AgnosticPerformance))
GSE32894_Out_MechPerformance$out_study <- rep("GSE32894", nrow(GSE32894_Out_MechPerformance))
GSE32894_Out_AgnosticPerformance$model_type <- rep("Agnostic", nrow(GSE32894_Out_AgnosticPerformance))
GSE32894_Out_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE32894_Out_MechPerformance))

# GSE57813_out
GSE57813_Out_AgnosticPerformance$out_study <- rep("GSE57813", nrow(GSE57813_Out_AgnosticPerformance))
GSE57813_Out_MechPerformance$out_study <- rep("GSE57813", nrow(GSE57813_Out_MechPerformance))
GSE57813_Out_AgnosticPerformance$model_type <- rep("Agnostic", nrow(GSE57813_Out_AgnosticPerformance))
GSE57813_Out_MechPerformance$model_type <- rep("Mechanistic", nrow(GSE57813_Out_MechPerformance))

# PMID_out
PMID_Out_AgnosticPerformance$out_study <- rep("PMID", nrow(PMID_Out_AgnosticPerformance))
PMID_Out_MechPerformance$out_study <- rep("PMID", nrow(PMID_Out_MechPerformance))
PMID_Out_AgnosticPerformance$model_type <- rep("Agnostic", nrow(PMID_Out_AgnosticPerformance))
PMID_Out_MechPerformance$model_type <- rep("Mechanistic", nrow(PMID_Out_MechPerformance))


All_KTSP_CV <- rbind(EMTAB_Out_AgnosticPerformance, EMTAB_Out_MechPerformance,
                     GSE13507_Out_AgnosticPerformance, GSE13507_Out_MechPerformance,
                     GSE32894_Out_AgnosticPerformance, GSE32894_Out_MechPerformance, 
                     GSE57813_Out_AgnosticPerformance, GSE57813_Out_MechPerformance, 
                     PMID_Out_AgnosticPerformance, PMID_Out_MechPerformance)
