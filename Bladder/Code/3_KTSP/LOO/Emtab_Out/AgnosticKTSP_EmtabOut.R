...
# plot the curve
ROCTest <- roc(usedTestGroup, ktspStatsTestUnRes$statistics, plot = F, print.auc=TRUE, ci= T, print.auc.col="black", levels = c("NoProgression", "Progression"), direction = "<", col= "blue", lwd=2, grid = TRUE, main = "Agnostic KTSP ROC Test")
ROCTest
...
EMTAB_Out_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(EMTAB_Out_AgnosticPerformance, file = "./Objs/KTSP/EMTAB_Out_AgnosticPerformance.rda")
