...
### TF_MIR genes
## Leaving 1 dataset out (GSE13507)
#################################################################################
...
GSE13507_Out_MechPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE13507_Out_MechPerformance, file = "./Objs/KTSP/GSE13507_Out_MechPerformance.rda")
...
### Plot
basicplot_KTSP_GSE13507Out
### Close device
dev.off()

save(basicplot_KTSP_GSE13507Out, file = "./Objs/KTSP/BasicPlot_KTSP_GSE13507out.rda")
#########################################
######
# html report
