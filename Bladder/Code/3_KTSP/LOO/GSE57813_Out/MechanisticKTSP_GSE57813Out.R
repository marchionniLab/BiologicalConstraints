...
### TF_MIR genes
## Leaving 1 dataset out (GSE57813)
#################################################################################
...
## Plot curve
ROCTest <- roc(usedTestGroup, ktspStatsTestRes$statistics, plot = F, ci = T, print.auc=TRUE, print.auc.col="black", levels = c("NoProgression", "Progression"), direction = "<", col="blue", lwd=2, grid=TRUE, main= "Mechanistic KTSP using TF_MiR Gns")
ROCTest
...
GSE57813_Out_MechPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE57813_Out_MechPerformance, file = "./Objs/KTSP/GSE57813_Out_MechPerformance.rda")
...
### Plot
basicplot_KTSP_GSE57813Out
### Close device
dev.off()

save(basicplot_KTSP_GSE57813Out, file = "./Objs/KTSP/BasicPlot_KTSP_GSE57813out.rda")
