...
ModelCompare_KTSP_RAND_DiffNoFeat <- rbind(ModelCompareAUCTrain_74,
...
save(ModelCompare_KTSP_RAND_DiffNoFeat, file = "./Objs/KTSP/ModelCompare_KTSP_RAND_DiffNoFeat.rda")
