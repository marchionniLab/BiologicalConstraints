...
GSE57813_Out_SVM_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE57813_Out_SVM_IndvGenes_AgnosticPerformance, file = "./Objs/SVM/GSE57813_Out_SVM_IndvGenes_AgnosticPerformance.rda")
