...
Grid <- expand.grid(degree = 3, scale = 0.001, C = 4)
set.seed(333)
...
GSE57813_Out_SVM_MechPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE57813_Out_SVM_MechPerformance, file = "./Objs/SVM/GSE57813_Out_SVM_MechPerformance.rda")
...
###################
### Plot Curve
png("./Figs/SVM/CompareAUCggplot_SVM_GSE57813Out.png",
    width=3000, height=3000, res=360)
### Color
myCol <- brewer.pal(3, "Dark2")[c(2,1)]
### Plot and legend titles
plotTitle <- "AUC mechanistic vs agnostic SVM (GSE57813 for validation)"
legendTitle <- "Mechanistic VS Agnostic"
### Plot
basicplot_SVM_GSE57813Out <- ggplot(dat_SVM, aes(d=Progression, m=SVM_sum, color=SVM_type,
                                                 linetype = SVM_type)) +
...
### Plot
basicplot_SVM_GSE57813Out
### Close device
dev.off()

########################

save(basicplot_SVM_GSE57813Out, file = "./Objs/SVM/BasicPlot_SVM_GSE57813Out.rda")
