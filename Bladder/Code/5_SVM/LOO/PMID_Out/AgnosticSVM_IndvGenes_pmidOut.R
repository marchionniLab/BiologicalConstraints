...
PMID_Out_SVM_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(PMID_Out_SVM_IndvGenes_AgnosticPerformance, file = "./Objs/SVM/PMID_Out_SVM_IndvGenes_AgnosticPerformance.rda")
