...
EMTAB_Out_SVM_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(EMTAB_Out_SVM_IndvGenes_AgnosticPerformance, file = "./Objs/SVM/EMTAB_Out_SVM_IndvGenes_AgnosticPerformance.rda")
