...
GSE32894_Out_SVM_IndvGenes_AgnosticPerformance <- cbind(TrainPerf, TestPerf)

# Save
save(GSE32894_Out_SVM_IndvGenes_AgnosticPerformance, file = "./Objs/SVM/GSE32894_Out_SVM_IndvGenes_AgnosticPerformance.rda")
