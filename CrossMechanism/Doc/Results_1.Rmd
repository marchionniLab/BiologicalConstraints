...
* krange $=50$, so the classifier will attempt to add upto 50 pairs

```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.width=10, fig.height=6}


l3 = load("../Objs/list.run.ktsp.rda")
...
* Take all mechanistic pairs available in the given dataset, take the genes forming these pairs
* Use these pairs to train a KTSP classifier with no statistical filtering (except for "GO" mechanism where top 100 DE genes are selected); allow upto 50 pairs to be selected (i.e. `krange=50`)
