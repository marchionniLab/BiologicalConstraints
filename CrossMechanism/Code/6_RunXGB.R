...
run_XGB_pairs = function(trainMat, testMat, trainGroup, testGroup, mechTSPs, filter=FALSE, 
                         classes=NULL, data_title, mech_title){
...
save(list.R.pairs, file="../CrossMechanism/Objs/list.R.xgb.2.rda")
save(list.run.pairs, file="../CrossMechanism/Objs/list.run.xgb.2.rda")
